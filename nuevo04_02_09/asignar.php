                    ...
                    <table width="493" height="246" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#8fb1d2">
                      <tr>
                        <td background="../img/fondo_cuerpo.gif"><center>
                            ...
                            <form id="form1" name="form1" method="post" action="asignar_save.php">
        ...
        <table width="400" border="0" align="left" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
          ...
          <tr>
            <td bgcolor="#B1CBE4"><table width="396" border="0" cellpadding="0" cellspacing="2">
				...
				<tr>
                  <td colspan="2" bgcolor="#CCDDEE" class="Estilo37"><p align="center">Los  Registros seleccionados son los siguientes: </p>
                    <p><span class="Estilo85">
					<table width="380" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#74ABD3">
				<? for ($i=0;$i<$long;$i++)
					{	
						if($i % 6==0)
						{
...
<!--                <tr>
                ...
                <tr>
                  <td colspan="2"><div align="center">
                      <input name="enviar222" type="submit" class="Estilo59" style="width:90px;background-color:#4791C5;border:0px;margin:1px;padding:0px; font-weight: bold;" value="Enviar" />
                    &nbsp;&nbsp;&nbsp;&nbsp;
