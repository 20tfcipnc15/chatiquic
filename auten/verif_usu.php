<?php
   ...
   $link=conexion();
   $consulta ="SELECT r.tipo 
               FROM remitente re INNER JOIN recibida r
               WHERE r.reg_interno = '$cod_nota' and r.id_remitente=re.id_remitente and re.cod_rem = '$ci'";
...
if($numResultados>0)
{
	...
	header("Location: reg_solicitado.php?cod=$cod_nota"); 
}
else
{
?>
