...
<form name="cuestionario" action="resp.php" method="post">
  <table width="802" border="0" align="center" cellpadding="1" cellspacing="0" bgcolor="#800040">
  <tr>
  ...
  <tr bgcolor="#FF6600">
    <td colspan="2"><table width="480" height="30" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="153" class="Estilo6">NOMBRE:</td>
    ...
    <td><table width="270" height="30" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="149" class="Estilo7">N&uacute;mero de encuesta pruebita de server </td>
...
user.style.top = mousey; 
          ...
          <td height="40" colspan="3" bgcolor="#000000"><table width="521">
              <tr>
                <td height="40"><span class="Estilo8">Otros</span><a class="thumbnail" href="#"><span><img src="fotos de las peliculas/54.jpg"/><br />
                  ...
                  <textarea style="width:450px; height:30px " name="otros" class="Estilo7" maxlength="200" onkeyup="return ismaxlength(this)"></textarea>
                </span></td>
              </tr>
            </table>
  ...
  <tr>
    <td colspan="3" bgcolor="#FF6600"><table width="295" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td class="Estilo7"><input type="submit" name="enviar" id="enviar" value="Enviar Cuestionario" />
        </td>
        <td class="Estilo7"><input type="reset" name="cancelar" id="cancelar" value="Cancelar Envio" />
        </td>
      </tr>
    </table></td>
  </tr>
  <tr bgcolor="#FF6600">
    <td colspan="3"><div align="right" class="Estilo6">
      <p><em><strong>te agradesco mucho tu ayuda y tu tiempo, espero te haya gustado, gracias..</strong></em><em><strong>. </strong></em></p>
      </div></td>
  </tr>
</table>
</form>
