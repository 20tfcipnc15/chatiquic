  ...
  <tr>
    <td height="248" colspan="2"><table width="780" border="0" cellpadding="0" cellspacing="0">
          <tr>
			...
			<table style="position:absolute;top:172px;left:1px;" width="132" height="100" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="66"><script src="menu_sp.js"></script></td>
              </tr>
              <tr>
                <td><p>&nbsp;</p>
                <p>&nbsp;</p>
                ...
                <tr>
                  ...
                  <td width="494" bgcolor="#336699"><div align="center">
                    <table width="490" height="246" border="2" cellpadding="0" cellspacing="0" bordercolor="#8fb1d2">
                      <tr>
                        <td background="../img/fondo_cuerpo.gif">                          <div align="left"><br>
                              <span class="Estilo77">&nbsp;&nbsp;Unidad: <? echo 
											 $unidad_ini; ?> <br>
                              &nbsp;&nbsp;Usuario: <? echo $nombre_ini; ?> </span></div>
                        <!--<form name="reporte" method="post" action="reporte/reporte_correspondencia1.php">-->
						<form name="reporte" method="post" action="reporte/reporte_diario_estado.php">
                                <div align="left">
                                  <table width="304" height="21" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td width="29" height="21" background="../img/encabezado_tabla_01.gif">&nbsp;</td>
                                      <td width="246" background="../img/encabezado_tabla_02.gif"><div align="center" class="Estilo59">REPORTE:C. RECIBIDA Y C. DESPACHADA </div></td>
                                      ...
                                      <td bgcolor="#B1CBE4"><table width="300" border="0" align="center" cellpadding="0" cellspacing="2">
                                        <tr>
                                          ...
                                          <td width="221" height="30" bgcolor="#CCDDEE"><span class="Estilo64"> &nbsp;
                                              ...
                                              <input name="calendario" type="button" class="Estilo59" style="width:90px;background-color:#4791C5;border:0px;margin:1px;padding:0px; font-weight: bold;" value="Calendario" onClick="abrir('../php/calendario4.php');">
                                          </span></td>
                                        </tr>
                                        <tr>
                            ...
                            <p align="left"><span class="Estilo64">
