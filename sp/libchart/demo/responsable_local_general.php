...
$pdf->SetFont('Times','B',12);
$pdf->Cell(0,4,'ESTADO ACTUAL DE LOS TRAMITES Y CORRESPONDENCIA: '.$unidad_show,0,1,'C');
...
{ 	
	...
	{  	
		...
		$consulta = "SELECT distinct(rut) FROM correspondencia WHERE destino like '$unidad_sol' ORDER BY id_c DESC";
