...
$pdf->Cell(10,7,'ENE',1,0,'C',1);
$pdf->Cell(10,7,'FEB',1,0,'C',1);
$pdf->Cell(10,7,'MAR',1,0,'C',1);
$pdf->Cell(10,7,'ABR',1,0,'C',1);
$pdf->Cell(10,7,'MAY',1,0,'C',1);
$pdf->Cell(10,7,'JUN',1,0,'C',1);
$pdf->Cell(10,7,'JUL',1,0,'C',1);
$pdf->Cell(10,7,'AGO',1,0,'C',1);
$pdf->Cell(10,7,'SEP',1,0,'C',1);
$pdf->Cell(10,7,'OCT',1,0,'C',1);
$pdf->Cell(10,7,'NOV',1,0,'C',1);
$pdf->Cell(10,7,'DIC',1,0,'C',1);
...
//		$fecha = $fecha.' 2010';
		...
		$sum = $sum + $numa;
		$pdf->Cell(10,6,$numa,1,0,'C');
		
        $total_mes[$i] = $total_mes[$i] + $numa;
...
for ($i=0;$i<=11; $i++)
{
	$pdf->Cell(10,7,$total_mes[$i],1,0,'C');
}
