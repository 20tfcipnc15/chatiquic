                                    ...
                                    <tr>
                                      <td bgcolor="#B1CBE4"><table width="396" border="0" align="center" cellpadding="0" cellspacing="2">
                                        <tr>
                                          ...
                                          <tr>
                                            <td width="130" height="15" bordercolor="#74ABD3"><div align="right"><span class="Estilo78">Fecha Final:</span></div></td>
...
{ 
	echo '<select name= "unidad_sol" style="width:248px" class="Estilo64">';
                                          ...
                                          <tr>
                                            <td height="15" colspan="2" class="Estilo78"><span class="Estilo65">
                                              ...
                                              <table width="390" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#CCDDEE">
                                                <tr>
                                                  <td bgcolor="#b1cbe4" class="Estilo78"><div align="right">Tipo:</div></td>
                                                ...
                                                <tr>
                                                  <td class="Estilo78"><div align="right">Seg&uacute;n su  Procedencia:</div></td>
                                                  <td><div align="center">
                                                ...
                                                <tr>
                                                  <td bgcolor="#b1cbe4" class="Estilo78"><div align="right">Tr&aacute;mites Conclu&iacute;dos: </div></td>
                                                  <td bgcolor="#b1cbe4"><div align="center">
                                                ...
                                                <tr>
                                                  ...
                                                  <td bgcolor="#b1cbe4" class="Estilo78"><div align="right">Mensajeros: </div></td>
                                                  <td bgcolor="#b1cbe4"><div align="center">
                                                      <input name="opcion" type="radio" value="mensajeros">
                                                  </div></td>
                                                </tr>  
					        <tr>
                                                  <td bgcolor="#b1cbe4" class="Estilo78"><div align="right">Porcentajes de Interaccion:</div></td>
                                                  <td bgcolor="#b1cbe4"><div align="center">
                                                      <input name="opcion" type="radio" value="porcentajes">
                                                  </div></td>
                                                  <td class="Estilo78"><div align="right"></div></td>
                                                  <td bgcolor="#b1cbe4"><div align="center">
