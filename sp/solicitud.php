<?php
//DEMASIADO MI AMOR BONITO,Tu Bebita y Esposita q te ama mucho Aleidita Bonita :)
session_start();
                      ...
                      <tr>
                        <td background="../img/fondo_cuerpo.gif"><center>
                            <p align="left" class="Estilo77"><br>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo 'Unidad: '; echo $unidad .' <br>&nbsp;&nbsp;&nbsp; Usuario: '. $nombre;?><br><br>
                              &nbsp;</p>
                          <form name="registro_recibida" method="post" action="resp.php">
                              <div align="left">
                                  ...
                                  <table width="400" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                                    ...
                                    <tr>
                                      <td bgcolor="#B1CBE4"><table width="396" border="0" align="center" cellpadding="0" cellspacing="2">
                                          ...
                                          <tr>
                                            <td height="15" bgcolor="#CCDDEE"><div align="right"><span class="Estilo78">R.U.T.: </span></div></td>
                                          ...
                                          <tr>
                                            <td height="15" class="Estilo78"><div align="right" class="Estilo78">Responsable:</div></td>
                                            <td background="../admin/img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                            <input name="responsable" value=""type="text" style="width:248px" class="Estilo64" onKeyPress="return solo_letras(event)" />
                                            </span></td>
                                          </tr>
                                          <tr>
                                            <td height="15" bgcolor="#CCDDEE" class="Estilo78"><div align="right">Tr&aacute;mites Conclu&iacute;dos :</div></td>
                                            <td background="../admin_bueno/img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo65">&nbsp;<input type="checkbox" name="archivo" value="si" id="checkbox">
                                ...
                                <p align="center" class="Estilo51">&nbsp;</p>
                                </div>
                              </form>
                            </center></td>
                        </tr>
