...
<body  bgcolor="#EDF7FF">
<form>
<table border="0" cellpadding="5" cellspacing="0" bgcolor="#8fb1d2" align="center">
  <tr>
    <td width="100%">
	<?
	$fecha = getdate(time());
...
?>
    ...
    <font size="1">&nbsp;</font>
	<table border="0" cellpadding="2" cellspacing="0" width="100%" class="m1" background="../img/fondo_cuerpo.gif" height="100%" align="center">
<?
