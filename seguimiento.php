...
if($filas > 0)
{
	...
	if($gestq >= $gest1y)  
	{
		...
		//filas9 para mostrar proveido segun el recibido y prov pa mostrar el proveido segun fecha y filas52 pa mostrar el proveido cuando el tramite se pone en pendiente
		
		
		if ($filas9>0 || $prov==0 || $filas52>0)
		{
		?>
			  <table width="142" height="25" border="0" align="left" class="Estilo78">
                <tr>
