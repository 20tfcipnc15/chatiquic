...
$sql = "SELECT nombre,id_unidad FROM user WHERE cargo = 'Mensajero' or cargo = 'Mensajera'  order by id_unidad ASC";
...
{ 	
	...
	{  	
		...
		$sql2 = "SELECT nombre FROM unidad WHERE id_unidad = '$id_unidad'";
