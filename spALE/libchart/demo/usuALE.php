...
$pdf->SetFont('Times','B',12);
$pdf->Cell(0,4,'CORRESPONDENCIA Y TRAMITES PENDIENTES: M.Sc. FATIMA DOLZ - DECANATO',0,1,'C');
...
{ 	
	...
	{  	*/
		...
		$consulta = "SELECT distinct(rut) FROM correspondencia WHERE destino like 'M.Sc. Fatima Dolz' ORDER BY id_c DESC";
