...
$pdf->SetFont('Times','B',12);
$pdf->Cell(0,4,'CORRESPONDENCIA Y TRAMITES PENDIENTES: CESAR CALDERON - DECANATO',0,1,'C');
...
{ 	
	...
	{  	*/
		...
		$consulta = "SELECT distinct(rut) FROM correspondencia WHERE destino like 'Cesar Calderon' or destino like 'Decanato' ORDER BY id_c DESC";
