...
//OBTENEMOS LOS DATOS DEL PENULTIMO REGISTRO
	...
	$pdf->Cell(15,6,'',0,0,'L');
	$pdf->Cell(30,6,'ORIGEN DE TRAMITE: ',0,0,'L');
	$pdf->Cell(30,6,$procedencia,0,1,'L');
	
	$pdf->Cell(15,6,'',0,0,'C');
	$pdf->Cell(15,6,'R.U.T.',1,0,'C');
	$pdf->Cell(30,6,'FECHA',1,0,'C');
	$pdf->Cell(30,6,'PROCEDENCIA',1,0,'C');
	$pdf->Cell(27,6,'RECIBIDO POR',1,0,'C');
	$pdf->Cell(30,6,'TIPO',1,0,'C');
	$pdf->Cell(15,6,'FOJAS',1,0,'C');
	$pdf->Cell(45,6,'REFERENCIAS',1,1,'C');
//	$pdf->ln();
...
//	$pdf->Cell(30,9,$procedencia,1,0,'C');
	...
	$pdf->Cell(27,9,$responsable,1,0,'C');
	$pdf->Cell(30,9,$tipo,1,0,'C');
	$pdf->Cell(15,9,$fojas,1,0,'C');
	$pdf->MultiCell(45,3,$referencias,1,1,'L');
}
$pdf->Ln();
$pdf->Output();
?>