...
$consulta ="SELECT id_user,nombre,contrasenia,id_unidad,cargo FROM user WHERE usuario like '$usuario' and contrasenia like '$password'";
...
document.write("<div class='Estilo13'><font color='#ffffff'><center><strong>Usted ha visitado nuestra Página <b><br>" + amt() + "</b> veces.<br> Gracias...!</strong></center></font></div>")
              ...
              <map name="Map9">
                ...
                <area shape="rect" coords="2,2,122,107" href="#">
              </map>
              <map name="Map10">
