                            ...
                            <table width="400" border="0" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                              ...
                              <tr>
                                <td bgcolor="#B1CBE4"><table width="396" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#EDF7FF">
                                    ...
                                    <tr>
                                      <td width="130" height="15" bordercolor="#74ABD3" class="Estilo78"><div align="right">Fecha y hora de salida:</div></td>
                                    ...
                                    <tr>
                                      <td height="15" class="Estilo78"><div align="right">Enviado por: </div></td>
                                      <td height="15" bgcolor="#E1F1FF" class="Estilo65">&nbsp;
                                      ...
                                      <td height="15" colspan="2" bgcolor="#CCDDEE" class="Estilo78"><div align="center">
                                          <form name="form4" method="post" action="reporte/rut_des.php">
                                            <p>&nbsp;                                              
											  ...
											  <input name="id_c" type="hidden" value="<? echo $id_c;?>">
                                              </p>
                                          </form><? }}?>
                                      </div></td>
                                    </tr>
