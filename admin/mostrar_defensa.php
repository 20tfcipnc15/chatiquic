...
$sql = "SELECT * FROM correspondencia WHERE id_c like '$id_c'";
...
$estado = $vec['estado'];
//effff
		$documentodef=$vec['documento'];
		$dudu1=substr("$documentodef",17,-5);
		//efffff
?>
<html>
<head>
                            ...
                            <table width="400" border="0" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                              ...
                              <tr>
                                <td bgcolor="#B1CBE4"><table width="396" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#EDF7FF">
                                    ...
                                    <tr>
                                      <td bgcolor="#CCDDEE"><div align="right"><span class="Estilo78">Dirigido:</span></div></td>
                                      <td height="15" bgcolor="#E1F1FF" class="Estilo65">&nbsp; <?php echo $destino;?></td>
                                    </tr>
                                    <tr>
                                      <td><div align="right"><span class="Estilo78">Correlativo:</span></div></td>
                                      <td height="15" bgcolor="#E1F1FF" class="Estilo65">&nbsp; <?php echo $correlativo;?></td>
                                    </tr>
                                    <tr>
                                      <td height="15" bgcolor="#CCDDEE" class="Estilo78"><div align="right">Universitario(a):</div></td>
                                      <td height="15" bgcolor="#E1F1FF" class="Estilo65">&nbsp;
                                    ...
                                    <tr>
                                      <td height="15" class="Estilo78"><div align="right">Estado:</div></td>
                                      <td height="15" bgcolor="#E1F1FF" class="Estilo65">&nbsp;
                                          <?php  echo $estado; ?>                                      </td>
                                    </tr>
									<tr>
										<td height="15" bgcolor="#CCDDEE" class="Estilo78"><div align="right">Documento Adjunto:</div></td>
										<td height="15" bgcolor="#E1F1FF" class="Estilo65">&nbsp;
										<?php  echo $dudu1;?>                                      </td>
									</tr>
                                    <tr>
                                      <td colspan="2" class="Estilo78" height="30">
                                        <div align="center">
                                        <!-- Modificacion 25/03/2015 -->
                                      	<a href="/reporte/boleta.php" target="popup" onClick="window.open('','popup','width=640,height=480,scrollbars=NO,menubar=NO,resizable=NO,titlebar=NO,status=NO');"></a>
                                          <form name="form1" method="post" action="reporte/boleta.php" target="popup" onSubmit="window.open('','popup','width=640,height=480,scrollbars=NO,menubar=NO,resizable=NO,titlebar=NO,status=NO');">
										  		<input type="hidden" value="<? echo $id_c;?>" name="id_c">
                                            	<input class="Estilo59" name="submit2" type="submit" style="cursor:pointer; background-color:#4791C5;border:0px;margin:1px;padding:0px; font-weight: bold;" value="Imprimir Boleta">
                                           </form>
                                          </div></td>
                                      </tr>
                                </table></td>
