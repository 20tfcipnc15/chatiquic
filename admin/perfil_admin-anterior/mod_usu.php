...
$usuario1 = $_POST['usuario'];
		...
		$consulta ="UPDATE user SET usuario = '$usuario1' WHERE id_user = '$id_user'";
		$resultado=mysql_query($consulta) or die ("Error de búsqueda en la BD: ". mysql_Error());
		
		$sql = "SELECT usuario FROM user WHERE id_user = '$id_user'"; 
        ...
        <td width="479" background="../../img/fondo_cuerpo.gif"><center>
		  ...
		  <table width="344" height="21" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="286" background="../../img/encabezado_tabla_02.gif"><div align="center" class="Estilo59">AHORA SU NOMBRE DE USUARIO ES: </div></td>
