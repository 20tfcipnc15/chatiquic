...
<table style="position:absolute;left:110px;" width="780" border="0" align="center" cellspacing="0">
  ...
  <tr>
    <td height="248" colspan="2"><table width="780" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="132" height="150" bgcolor="#8fb1d2"><table style="position:absolute; left: 4px; top:172px;" width="132" height="92" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td height="92"><script src="menu_perfil.js"></script></td>
            </tr>
        </table></td>
        <td bgcolor="#EDF7FF" width="2"></td>
        <td width="644" height="248" align="right" bgcolor="#8fb1d2"><table width="640" height="242" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#8fb1d2" style="position:left;" heigth="500">
          <tr>
            <td background="../../img/fondo_cuerpo.gif" bgcolor="#8fb1d2"><center>
              <table width="344" height="21" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="29" height="21" background="../../img/encabezado_tabla_01.gif"></td>
                  <td width="286" background="../../img/encabezado_tabla_02.gif"><div align="center" class="Estilo59"> NOMBRE </div></td>
                ...
                <tr>
                  <td bgcolor="#B1CBE4"><table width="340" border="0" align="center" cellpadding="0" cellspacing="2">
                      <tr>
                        ...
                        <td width="260" bgcolor="#CCDDEE" class="Estilo65">&nbsp;&nbsp; <? echo $nombre;?></td>
                      </tr>
                      <tr>
                        <td height="10" colspan="2" class="Estilo59"></td>
                      </tr>
                      <tr>
                        <td height="18" colspan="2" bgcolor="#CCDDEE" class="Estilo78"><div align="center"><strong>Su Nombre de Usuario ha sido modificado correctamente...! </strong> </div></td>
                      </tr>
                      <tr>
