...
<table style="position:absolute;left:110px;" width="780" border="0" align="center" cellspacing="0">
  ...
  <tr>
    <td colspan="2">
    <table height="160" width="780" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="132" bgcolor="#8fb1d2"><table style="position:absolute; left: 5px; top:170px;" width="132" height="92" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td height="92"><script src="menu_perfil.js"></script></td>
            </tr>
        </table></td>
        <td bgcolor="#EDF7FF" width="2"></td>
        <td width="491" height="200" align="right" bgcolor="#8fb1d2"><table width="489" height="160" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td background="../../img/fondo_cuerpo.gif"><form name="form1" method="post" action="mod_pass1.php">
                <br>
                <table width="374" height="21" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
