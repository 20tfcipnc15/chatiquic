...
<table style="position:absolute;left:110px;" width="780" border="0" align="center" cellspacing="0">
  <tr>
    ...
    <td width="510" height="28" bordercolor="0" background="../../img/fondo_banner_rojo1.gif"><div align="right" class="Estilo13"> <strong><font color="#ffffff">
      <SCRIPT>today();</SCRIPT>
    </font> </strong></div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="133" colspan="2"><table width="780" height="131" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="132" height="110" background="../../img/encabezado_01.gif"><div align="center"><img src="../../img/umsa_escudo1.gif" width="54" height="106"></div></td>
          ...
          <tr>
            <td background="../../img/fondo_cuerpo.gif" bgcolor="#8fb1d2"><table width="420" border="0" align="center" cellpadding="0" cellspacing="0" heigth="21">
              <tr>
                ...
                <td width="197"><span class="Estilo21 Estilo88"> <a href="mailto: hemeroteca@correo.umsa.bo" class="Estilo21">E-mail: fcpn@yahoo.es</a></span></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
  ...
  <tr>
    <td colspan="2">
    <table height="150" width="780" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="494" align="right" bgcolor="#8fb1d2"><table width="491" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="140" background="../../img/fondo_cuerpo.gif">
            <br>
            <form name="form1" method="post" action="mod_usu1.php">
            <table width="324" height="21" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="29" height="21" background="../../img/encabezado_tabla_01.gif"></td>
                  <td width="266" background="../../img/encabezado_tabla_02.gif"><div align="center" class="Estilo59">MODIFICAR MI NOMBRE DE USUARIO </div></td>
                    ...
                    <td bgcolor="#B1CBE4"><table width="320" border="0" align="center" cellpadding="0" cellspacing="2">
                        <tr>
                          ...
                          <td width="260" bgcolor="#CCDDEE" class="Estilo65">&nbsp;&nbsp;
                              <input type="text" name="usuario" value="<? echo $usuario;?>" onKeyPress="return numeros_letras(event)"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td height="17" colspan="2" bgcolor="#CCDDEE" class="Estilo59"><div align="center">
                              <input name="cambiar_usu" type="submit" class="Estilo59" id="cambiar_" style="width:90px;background-color:#4791C5;border:0px;margin:1px;padding:0px; font-weight: bold;" value="Modificar">
                            &nbsp;&nbsp;&nbsp;&nbsp;
