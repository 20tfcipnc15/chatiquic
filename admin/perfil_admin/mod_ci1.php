...
$password=$_SESSION['password']; 
	...
	$ci1=$_POST['ci'];
	$sql = "SELECT id_user FROM user WHERE id_user = '$user'"; 
	...
	if($num>0)
	{
		...
		$consulta ="UPDATE user SET ci = '$ci1' WHERE id_user = '$id_user'";
		$resultado=mysql_query($consulta) or die ("Error de búsqueda en la BD: ". mysql_Error());
		
		$sql = "SELECT ci FROM user WHERE id_user = '$id_user'"; 
		$resp = mysql_query($sql);
		$num = mysql_num_rows($resp);
		if($num>0)
		{
...
<table style="position:absolute;left:110px;" width="780" border="0" align="center" cellspacing="0">
  ...
  <tr>
    <td height="161" colspan="2"><table height="161" width="780" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="494" align="right" bgcolor="#8fb1d2"><table width="491" height="157" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="148" background="../../img/fondo_cuerpo.gif"><table width="344" height="21" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="29" height="21" background="../../img/encabezado_tabla_01.gif"></td>
                  <td width="286" background="../../img/encabezado_tabla_02.gif"><div align="center" class="Estilo59">SU N&Uacute;MERO DE C.I. ES: </div></td>
                ...
                <table width="344" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                  ...
                  <tr>
                    <td bgcolor="#B1CBE4"><table width="340" border="0" align="center" cellpadding="0" cellspacing="2">
                        <tr>
                          <td width="130" height="15" bordercolor="#74ABD3" bgcolor="#CCDDEE"><div align="right"><span class="Estilo78">C.I.::</span></div></td>
                          <td width="260" bgcolor="#CCDDEE" class="Estilo65">&nbsp;&nbsp;<? echo $ci;?></td>
                        </tr>
                        <tr>
                          <td height="10" colspan="2" class="Estilo59"></td>
                        </tr>
                        <tr>
                          <td height="18" colspan="2" bgcolor="#CCDDEE" class="Estilo78"><div align="center"><strong>Su N&uacute;mero de C.I. ha sido modificado correctamente...! </strong> </div></td>
                        </tr>
                        <tr>
