...
$sql = "SELECT ci FROM user WHERE usuario like '%$nombre%' and contrasenia like '%$password%'"; 
...
<table style="position:absolute;left:110px;" width="780" border="0" align="center" cellspacing="0">
  ...
  <tr>
    <td height="168" colspan="2"><table height="168" width="780" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="494" align="right" bgcolor="#8fb1d2"><table width="491" height="157" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="148" background="../../img/fondo_cuerpo.gif"><br>
                <form name="form1" method="post" action="mod_ci1.php">
                  ...
                  <table width="324" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                    ...
                    <tr>
                      <td bgcolor="#B1CBE4"><table width="320" border="0" align="center" cellpadding="0" cellspacing="2">
                          <tr>
                            <td width="130" height="15" bordercolor="#74ABD3" bgcolor="#CCDDEE"><div align="right"><span class="Estilo78">CI: </span></div></td>
                            <td width="260" bgcolor="#CCDDEE" class="Estilo65">&nbsp;&nbsp;<span class="Estilo78">
                              <input type="text" name="ci" value="<? echo $ci;?>" onKeyPress="return solo_numeros(event)">
                            </span></td>
                          </tr>
                          <tr>
