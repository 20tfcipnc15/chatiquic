                    ...
                    <table width="490" height="246" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#8fb1d2">
                        <tr>
                                           <td background="../img/fondo_cuerpo.gif"><p><br>
                                             <span class="Estilo77">&nbsp;&nbsp;&nbsp;&nbsp;Unidad: <?php echo $unidad;?><br>
&nbsp;&nbsp;&nbsp;&nbsp;Usuario: 
<? echo $nombre; ?>
                                             </span></p>
                                             <p align="center" class="Estilo77">Introduzca uno o varios Par&aacute;metros</p>
                                             <p align="center" class="Estilo77">Para Realizar la B&uacute;squda</p>
                                            
                                             <center><form name="registro_recibida" method="post" action="reg_solicitado.php">
