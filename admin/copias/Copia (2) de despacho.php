                                               ...
                                               <table width="400" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                                                 ...
                                                 <tr>
                                                   <td bgcolor="#B1CBE4"><table width="396" border="0" cellpadding="0" cellspacing="2">
                                                       ...
                                                       <tr>
                                                         <td height="21" bgcolor="#CCDDEE" class="Estilo37"><div align="right">Despacho Interno: </div></td>
                                                         <td bgcolor="#CCDDEE">
...
?></td>
                                                       ...
                                                       <tr>
                                                         ...
                                                         <td width="257" bgcolor="#CCDDEE">&nbsp;<input type="checkbox" name="archivar" value="checkbox" id="checkbox"></td>
                                                       </tr>
