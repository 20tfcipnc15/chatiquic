    ...
    <td height="248" colspan="2"><table width="780" border="0" cellpadding="0" cellspacing="0">
          <tr>
			...
			<table width="132" height="246" border="0" cellpadding="0" cellspacing="0" align="center">
              ...
              <tr height="117">
                <td><table style="position:absolute;top:171px;left:3px;"width="132" height="240" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                                               ...
                                               <table width="400" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                                                 ...
                                                 <tr>
                                                   <td bgcolor="#B1CBE4"><table width="396" border="0" cellpadding="0" cellspacing="2">
                                                       ...
                                                       <tr>
                                                         <td bgcolor="#CCDDEE" class="Estilo37"><div align="right">Despacho Interno: </div></td>
                                                         <td width="257" bgcolor="#CCDDEE">&nbsp;&nbsp;<? $result=mysql_query("select nombre from  user  where id_unidad = '$id_unidad' order by nombre DESC",$link);
//Llenamos el combo
...
?>                                                         </td>
                                                       ...
                                                       <tr>
                                                         ...
                                                         <td>&nbsp;&nbsp;<select name="estado" tyle="width:248px" class="Estilo64">
