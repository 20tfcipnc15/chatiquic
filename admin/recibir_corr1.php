...
$consulta = "SELECT nombre FROM user WHERE id_unidad = $id_unidad1 and cargo like '%Mensajer%'";
		...
		<table width="1000" height="246" border="0" cellpadding="0" cellspacing="0" align="center">
            <tr height="117">
			  ...
			  <form name="form1" method="post" action="recupera.php">
               <table style="position:absolute; top:125px; left:838px; width: 149px; height: 120px;"width="132" height="190" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="132" height="62"><table width="144" height="75" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                        <tr>
  ...
  &nbsp;&nbsp;Usuario: <? echo $nombre1; ?></p>
                    ...
                    <table width="765" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td width="712" background="../img/encabezado_tabla_02.gif"><div align="center" class="Estilo59">BANDEJA DE ENTRADA </div></td>
                        ...
                        <td bgcolor="#B1CBE4"><table width="696" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#EDF7FF">
                            <tr>
                              ...
                              <td height="15" bgcolor="#4791C5" class="Estilo2"><div align="center">
                                <p>  <button class="Estilo59" style="width:50px;background-color:#4791C5;border:0px;margin:1px;padding:0px; font-weight: bold;" onClick="valoresa(this.form, 'a[]')">Asignar</button></p>
                              </div></td>
                              ...
                              <td width="50" bgcolor="#4791C5"><div align="center" class="Estilo2">Correlativo</div></td>
...
//query: "SELECT * FROM correspondencia WHERE sw = 1 and (destino like '$unidad' or destino like '$nombre1')  GROUP BY rut order by id_c DESC";
$sql = "SELECT * FROM correspondencia WHERE sw = 1 and (destino like '$unidad' or destino like '$nombre1')  GROUP BY rut, referencias order by id_c DESC";
...
{			
		...
		{	
			...
			$sql7 = "SELECT id_c FROM recibido WHERE id_c = '$id_c' and recibido_por like '%$nombre1%'";
...
//		if($imprimir == 1 and $alert != 4)
		if($imprimir == 1)
		{
			...
			$sqlr = "SELECT rut FROM reportes WHERE fecha_sol like '%2014%' and rut like '%,$rut,%' and responsable like '$nombre'";
...
onClick="abrir4('reporte/reporte_rut_rec.php?rut='+'<? echo $unidad;?>'+','+'<? echo $rut;?>'+','+'<? echo $tipo;?>'+','+'<? echo $fecha;?>'+','+'<? echo $nombre1;?>'+','+'<? echo $fojas;?>'+','+'<? echo $estado1;?>'+','+'<? echo $id_c;?>'+','+'<? echo $id_unidad;?>');">
<?
			echo '</center></td>';
            }			
			elseif ($alert == 0)
...
onClick="abrir4('reporte/reporte_rut_rec.php?rut='+'<? echo $unidad;?>'+','+'<? echo $rut;?>'+','+'<? echo $tipo;?>'+','+'<? echo $fecha;?>'+','+'<? echo $nombre;?>'+','+'<? echo $fojas;?>'+','+'<? echo $estado1;?>'+','+'<? echo $id_c;?>'+','+'<? echo $id_unidad;?>');">
<?
				echo '</center></td>';
			}
	        echo '<td height="50" bgcolor="#E1F1FF" class="Estilo78"><center>'; 
...
?>
                            ...
                            <tr>
							  ...
							  <button class="Estilo59" style="width:50px;background-color:#4791C5;border:0px;margin:1px;padding:0px; font-weight: bold;" onClick="valores(this.form, 't[]')">Imprimir</button>
