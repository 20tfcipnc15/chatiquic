    ...
    <td height="248" colspan="2"><table width="133" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td bgcolor="#B1CBE4"><table width="698" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#EDF7FF">
                              <tr>
                                ...
                                <td width="72" height="15" bgcolor="#4791C5" class="Estilo2"><div align="center">Fecha Ingreso </div></td>
                                <td width="81" bgcolor="#4791C5"><div align="center" class="Estilo2">Procedencia</div></td>
                                <td width="85" bgcolor="#4791C5"><div align="center" class="Estilo2">Tipo de Tr&aacute;mite </div></td>
                                <td width="70" bgcolor="#4791C5" class="Estilo2"><div align="center">Reg. Ext. </div></td>
                                <td width="116" bgcolor="#4791C5"><div align="center" class="Estilo2">Referencias</div></td>
                                <td width="37" bgcolor="#4791C5"><div align="center" class="Estilo2">Fojas</div></td>
                                <td width="75" bgcolor="#4791C5"><div align="center" class="Estilo2">Destino</div></td>
	  ...
	  ?>
                              <tr>
                                ...
                                <td width="72" height="15" bgcolor="#E1F1FF" class="Estilo78"><div align="center"><? echo $fecha1;?></div></td>
                                <td width="81" bgcolor="#E1F1FF"><div align="center"><span class="Estilo78"><? echo $unidad;?></span></div></td>
                                <td width="85" bgcolor="#E1F1FF"><div align="center"><span class="Estilo78"><? echo $tipo;?></span></div></td>
...
<? echo' <td width="170" height="50" bgcolor="#E1F1FF"><center><table width="166" height="50"><tr><td><div align="left" class="Estilo78">';
                                ...
                                <td width="116" bgcolor="#E1F1FF"><div align="center"><span class="Estilo78"><? echo $fojas;?></span></div></td>
                                <td width="37" bgcolor="#E1F1FF"><div align="center"><span class="Estilo78"><? echo $destino;?></span></div></td>
							    <td width="75" bgcolor="#E1F1FF"><div align="center"><span class="Estilo78"><? echo $responsable; 
								$i++;?></span></div></td>
								</tr>
                              <tr>
