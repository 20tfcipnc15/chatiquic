...
if($procedencia!=null)
{
	$consulta ="UPDATE correspondencia SET unidad = '$procedencia' WHERE id_c = '$id_c'";
	$resultado=mysql_query($consulta) or die ("Error de búsqueda en la BD: ". mysql_Error());
}
if($correlativo!=null)
{
...
if($referencias!=null)
{
	$consulta ="UPDATE correspondencia SET referencias = '$referencias' WHERE id_c = '$id_c'";
	$resultado=mysql_query($consulta) or die ("Error de búsqueda en la BD: ". mysql_Error());
}
if($fojas!=null)
{
                ...
                <td><table width="480" height="246" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#8fb1d2">
                  <tr>
                    <td background="../img/fondo_cuerpo.gif"><center>
                      ...
                      <p align="center"> <span class="Estilo77">Datos Actuales del  Registro Modificado
                      </span></p>
