...
$consulta1 ="SELECT * FROM unidad WHERE nombre like '%$unidad%'";
...
$consulta ="SELECT id_user,nombre,contrasenia
		   FROM user
		   WHERE usuario like '%$usuario%' and contrasenia like '%$password%' and id_unidad = 
		   '$id_unidad'";
$resultado=mysql_query($consulta) or die ("Error de búsqueda en la BD: ". mysql_Error());
$numResultados = mysql_num_rows($resultado);
if($numResultados > 0 and $usuario !=null and $password !=null and $unidad !=null)
   {   
