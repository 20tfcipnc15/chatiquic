...
$para = $_POST['para'];
$otro = $_POST['otro'];
if($para==null and $otro!=null)
	$para=$otro;
$asunto = $_POST['asunto'];
if($asunto==null)
	$asunto='Notificación de su trámite';
...
<h1>Hola...!</h1>
<p>
<b>'.$mensaje.'Esto es una prueba.</b> 
</p>
</body>
</html>
';
...
$headers .= "From: Ciencias Puras - ".$de." <dec_fcpn@yahoo.es>\r\n";
//dirección de respuesta, si queremos que sea distinta que la del remitente
//$headers .= "Reply-To: maria@desarrolloweb.com\r\n";
//direcciones que recibián copia
//$headers .= "Cc: mariano@desarrolloweb.com\r\n";
...
?>
<table style="position:absolute;left:110px;" width="784" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td><table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td background="../img/fondo_cuerpo.gif" bgcolor="#8fb1d2"><table width="420" border="0" align="center" cellpadding="0" cellspacing="0" heigth="21">
                        <tr>
                          ...
                          <td width="197"><span class="Estilo21 Estilo80"> <a href="mailto: hemeroteca@correo.umsa.bo" class="Estilo21">E-mail: dec_fcpn@yahoo.es</a></span></td>
                        </tr>
                    </table></td>
                  </tr>
              </table></td>
      ...
      <tr>
        <td colspan="2"><table width="780" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td width="132" height="246" bgcolor="#8fb1d2"><table style="position:absolute;top:170px;left:3px;" width="132" height="246" border="0" cellpadding="0" cellspacing="0" align="center">
                  <tr height="123">
