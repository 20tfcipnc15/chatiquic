...
<script language=JavaScript src="../javascript/jquery-validation-1.13.1/dist/jquery.validate.min.js"></script>
...
$(document).ready(function(){
						...
						var tramite=$('select[id=tipo]').val();
						$('input[id=tipo]').val($(this).val());
						
						if(tramite=='Solicitud de Compra')
						{
...
/*function modalWin(valor) 
{
window.open("formularios.php?place="+valor,"ventana1","width=420,height=300,top=150, left=300,scrollbars=NO,continued from previous linemenubar=no,scrollbars=no,resizable=no ,modal=yes"); 
}*/
                    ...
                    <table width="493" height="246" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#8fb1d2">
                      <tr>
                        <td background="../img/fondo_cuerpo.gif"><center>
                            ...
                            <form name="reg_despacho" method="post" action="despacho_save_x.php">
...
{ 
	echo '<select name="tipo" id="tipo" style="width:248px" class="Estilo64" onchange=""nameFunction()">';
...
<div id="comprabien" title="Solicitud de Compra" style="display:none">
<form action="" method="post" id="SolCompra" name="SolCompra">
<h3>LLENE LOS SIGUIENTES DATOS DE MANERA CORRECTA</h3>
<fieldset id="datoscompra">
	<label for=""></label>
</form>
</div>
                                      </tr>
...
?>
                                      ...
                                      <tr>
                                        <td height="15" class="Estilo78"><div align="right"><span class="Estilo78">Instrucci&oacute;n:</span></div></td>
					      ...
					      <option value="PF">PF: Para Firma</Para Firma>
