                                      ...
                                      <td bgcolor="#B1CBE4"><table width="396" border="0" align="center" cellpadding="0" cellspacing="2">
                                          <tr>
                                            ...
                                            <td width="260" bgcolor="#CCDDEE"><span class="Estilo64"> &nbsp;
                                                  <input name="fecha" type="text" class="Estilo64" style="width:120px" value="2015" onKeyPress="return numeros_letras(event)" />
...
$result=mysql_query("select sigla,nombre from unidad where id_unidad < 75 order by nombre ASC",$link);
//Llenamos el combo
if ($row = mysql_fetch_array($result))
{ 
...
?>
                                          ...
                                          <tr>
                                            <td height="15" bgcolor="#CCDDEE" class="Estilo78"><div align="right" class="Estilo78">Destino / Responsable:</div></td>
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
