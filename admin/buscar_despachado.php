                ...
                <tr>
                  ...
                  <td width="494" bgcolor="#336699"><div align="center">
                    <table width="490" height="246" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#8fb1d2">
                        <tr>
                                           <td background="../img/fondo_cuerpo.gif"><br>
										    <span class="Estilo77">&nbsp;&nbsp;Usuario: <? echo $nom;?></span><br>
										   <center>
                                             <form name="registro_recibida" method="post" action="despachado_solicitado.php">
                                               ...
                                               <table width="400" height="21" border="0" cellpadding="0" cellspacing="0">
                                                 <tr>
                                                   ...
                                                   <td width="342" background="../img/encabezado_tabla_02.gif"><div align="center" class="Estilo59">CORRESPONDENCIA DESPACHADA </div></td>
                                               ...
                                               <table width="400" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                                                 ...
                                                 <tr>
                                                   <td bgcolor="#B1CBE4"><table width="396" border="0" align="center" cellpadding="0" cellspacing="2">
													   <tr>
                                                         <td width="130" height="15" bordercolor="#74ABD3" bgcolor="#CCDDEE"><div align="right"><span class="Estilo78">Desde Fecha: </span></div></td>
													   ...
													   ?>
                                                         ...
                                                         &nbsp;
                                                         <input name="fec_inicial" type="text" class="Estilo64" style="width:120px" value="" onKeyPress="return numeros_letras(event)"/>
														 <input name="calendario" type="Reset" class="Estilo59" style="width:90px;background-color:#4791C5;border:0px;margin:1px;padding:0px; font-weight: bold;" value="Calendario" onClick="abrir('../php/calendario.php');">
                                                         </span></td>
                                                       </tr><tr>
                                                         <td width="130" height="15" bordercolor="#74ABD3" bgcolor="#CCDDEE"><div align="right"><span class="Estilo78">Hasta</span></div></td>
                                                         <td width="260" bgcolor="#CCDDEE"><span class="Estilo64">
                                                         &nbsp;
                                                         <input name="fec_final" type="text" class="Estilo64" style="width:120px" value="" onKeyPress="return numeros_letras(event)"/>
														 <input name="calendario" type="Reset" class="Estilo59" style="width:90px;background-color:#4791C5;border:0px;margin:1px;padding:0px; font-weight: bold;" value="Calendario" onClick="abrir('../php/calendario.php');">
                                                         </span></td>
                                                       </tr>
                                                       <tr>
                                                         <td height="15"><div align="right" class="Estilo78">Tipo de Correspondencia: </div></td>
                                                         <td height="15" bgcolor="#CCDDEE" class="Estilo59">&nbsp;
                                                             <select name="tipo" style="width:248px" class="Estilo64">
                                                               ...
                                                               <option>Notas Despachadas</option>
													   ...
													   <tr>
                                                         <td height="15" bgcolor="#CCDDEE"><div align="right"><span class="Estilo78">Correlativo:</span></div></td>
                                                       ...
                                                       <tr>
                                                         <td height="15"><div align="right"><span class="Estilo78">N&ordm; Hoja de Ruta: </span><span class="Estilo74"></span></div></td>
                                                         <td bgcolor="#CCDDEE" class="Estilo64">&nbsp;
                                                         <input name="hoja_ruta" value="" type="text" style="width:248px" class="Estilo64" onKeyPress="return solo_numeros(event)" /></td>
                                                       </tr>
                                                       <tr>
                                                         <td height="15"><div align="right"><span class="Estilo78">Dirigido:</span></div></td>
                                                         <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><p class="Estilo64">&nbsp;
                                                           <select name="dirigido" style="width:248px" class="Estilo64">
															 <option selected></option>
                                                       ...
                                                       <tr>
                                                         ...
                                                         <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                                               <input name="otro" type="text" style="width:248px" class="Estilo64" onKeyPress="return solo_letras(event)" />
                                                         </span></td>
                                                       </tr>
                                                       <tr>
