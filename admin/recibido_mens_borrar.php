...
<table  width="1000" border="0" cellspacing="0">
  ...
  &nbsp;&nbsp;Usuario: <? echo $nombre; ?></p>
                      <form action="recibido_mens.php" method="POST" name="gestion">
...
/*			$ip = $_SERVER['REMOTE_ADDR'];
			...
			(NULL,'$rut','$unidad','$fecha_fin','$correlativo','$hoja_ruta','$tipo','$referencias','$fojas','SISTEMA','$procedencia','$proveido','$ip','$estado')";
