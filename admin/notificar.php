          ...
          <tr>
            ...
            <td width="497" rowspan="3"><div align="center">
              <table width="493" height="246" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="490" bgcolor="#8fb1d2"><div align="center">
                    <table width="492" height="246" border="0" align="center" cellpadding="0" cellspacing="3" bordercolor="#8fb1d2">
                      <tr>
                        <td background="../img/fondo_cuerpo.gif"><center>
                            <p align="left" class="Estilo77">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo 'Unidad: '; echo $unidad .' <br>&nbsp;&nbsp;&nbsp; Usuario: '. $nombre;?><br>
                                <br>
                              &nbsp;</p>
                          <form name="registro_recibida" method="post" action="not_enlace.php">
                              <div align="left">
                                <p align="center" class="Estilo77">Elija el tipo de Notificacion que desea enviar</p>
                                <table width="270" height="21" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <td width="29" height="21" background="../img/encabezado_tabla_01.gif">&nbsp;</td>
                                    <td width="212" background="../img/encabezado_tabla_02.gif"><div align="center" class="Estilo59">NOTIFICACIONES</div></td>
                                ...
                                <table width="270" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                                  ...
                                  <tr>
                                    <td bgcolor="#B1CBE4"><table width="260" border="0" align="center" cellpadding="4" cellspacing="3">
                                        <tr>
                                          <td width="132" height="28" bgcolor="#CCDDEE" class="Estilo15"><div align="right">E - mail:</div></td>
                                          <td width="107" background="../admin/img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><div align="center">
                                            <input name="r_not" type="radio" value="r_mail"checked>
                                              <label for="radiobutton"></label>
                                          </div></td>
                                        </tr>
                                        <tr>
                                          <td height="20" bgcolor="#CCDDEE" class="Estilo15"><div align="right">SMS:</div></td>
                                          <td height="20" bgcolor="#CCDDEE" class="Estilo59"><div align="center">
                                            <input name="r_not" type="radio" value="r_sms">
                                              <label for="radio"></label>
                                          </div></td>
                                        </tr>
                                        <tr>
                                          <td height="30" colspan="2" bgcolor="#CCDDEE" class="Estilo59"><table width="250" height="28" border="0" align="center" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td width="229" bgcolor="#B1CBE4"><div align="center">
...
<table style="position:absolute;top:172px;left:111px;"width="132" height="240" border="0" cellpadding="0" cellspacing="0">
  <tr>
