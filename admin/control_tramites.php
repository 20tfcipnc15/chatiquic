              ...
              <table width="870" height="246" border="2" cellpadding="0" cellspacing="0" bordercolor="#8fb1d2" align="center">
                <tr>
                  <td background="../img/fondo_cuerpo.gif"><center>
                      ...
                      <br>
		      <p align="center" class="estilo77">Registros de Correspondencia Usuario: <?php echo $nombre_control;?></p>
                        ...
                        <form name="f1">
                          <tr>
                            <td bgcolor="#B1CBE4"><table width="837" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#EDF7FF">
                                <tr>
								  <td width="59" height="15" bgcolor="#4791C5" class="Estilo2"><div align="center">Nro.</div></td>
...
<?
$a=0;
$consulta = "SELECT * FROM correspondencia WHERE sw = 1 and destino like '$nombre_control' GROUP BY rut order by id_c DESC";
...
$to = $aa + $bb + $cc + $dd;
//echo "<font color='black' face=Arial size=4>TRAMITES: </font> <font color='green' face=Arial size=4 >Sin Alerta: $aa </font>-- <font color='yellow' face=Arial size=4 >Alerta Amarilla: $cc </font>-- <font color='red' face=Arial size=4>Alerta Roja: $bb</font> -- <font color='orange' face=Arial size=4>Pendiente: $dd </font> -- <font color='blue' face=Arial size=4>Total Tramites: $to</font>";
?>
                                <tr>
