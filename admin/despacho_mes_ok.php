...
?>
                            ...
                            <form name="despacho_mens" method="post" action="des_interno1.php">
                                        ...
                                        <td height="10" colspan="2" class="Estilo59"><table width="390" border="0" cellpadding="0" cellspacing="2">
                                            ...
                                            <tr>
                                              ...
                                              <td width="257" background="../admin_bueno/img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo65"> &nbsp;&nbsp;
                                                    <input type="checkbox" name="archivar" value="checkbox" id="checkbox">
...
$result=mysql_query("select * from unidad WHERE id_unidad < 75 order by nombre ASC",$link);
//Llenamos el combo
if ($row = mysql_fetch_array($result))
{ 
...
?>
                              ...
                              <p>
                                <input name="mens" type="hidden" value="<? echo $cargo1; }?>">
                              </p>
                            </form>
