...
<?
$result=mysql_query("select * from unidad where id_unidad < 65 order by nombre ASC",$link);
//Llenamos el combo
...
?>
                                        ...
                                        <tr>
                                          <td height="15" bgcolor="#CCDDEE"><div align="right"><span class="Estilo78">Asignaci&oacute;n:</span></div></td>
