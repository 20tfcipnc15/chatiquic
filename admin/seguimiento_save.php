...
$consulta ="UPDATE correspondencia SET sw = 0 WHERE id_c = '$idc2'";
...
$sql="INSERT INTO correspondencia (id_c,rut,unidad,fecha,correlativo,hoja_ruta,tipo,referencias,fojas,responsable,destino,comentario,ip,estado,sw) VALUES (NULL,'$rut','$procedencia','$fecha','$reg_ext','$hoja_ruta','$tipo','$referencias','$fojas','$nombre','$unidad_ini','$comentario','$ip','$estado','0')";
...
$sql="INSERT INTO correspondencia (id_c,rut,unidad,fecha,correlativo,hoja_ruta,tipo,referencias,fojas,responsable,destino,ip,estado,sw) VALUES (NULL,'$rut','$unidad_ini','$fecha','$reg_ext','$hoja_ruta','$tipo','$referencias','$fojas','$nombre','$destino','$ip','$estado','1')";
$result = mysql_query($sql,$link);
