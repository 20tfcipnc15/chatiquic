...
day = new Date();
id = day.getTime();
eval("page" + id + " = window.open(URL, '" + id + "', 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=250,height=158,left = 410,top = 260');");
}*/
// End -->
</script>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0" bgcolor="#EDF7FF" oncontextmenu="return false" onLoad="javascript:popUp('msj.php')">
<table width="780" border="0" align="center" cellspacing="0">
  ...
  <tr>
    <td height="150" colspan="2"><table width="780" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="132" height="150" bgcolor="#8fb1d2">
			<table width="132" height="150" border="0" cellpadding="0" cellspacing="0" align="center">
              <tr height="117">
                <td>
            ...
            <td width="498" rowspan="3"><div align="center">
              <table width="498" height="150" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="2">&nbsp;</td>
                  <td width="494" bgcolor="#336699"><div align="center">
                    <table width="490" height="250" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#8fb1d2">
                        <tr>
                                           <td background="../img/fondo_cuerpo.gif"><center>
					   <img src="../img/universidad.jpg" width="361" height="240">
                                           </center></td>
                        </tr>
                      </table>
                                       </div></td>
            ...
            <td width="150" rowspan="3" bgcolor="#8fb1d2">
              <table width="146" border="0" align="center" cellpadding="0" cellspacing="2">
                <tr>
              ...
              <td width="498"><div align="center">
                <table width="490" height="21" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="264" background="../img/fondo_encabezado_grande_03.gif"><div align="center" class="Estilo17">Proyecto TIC-Facultativo</div></td>
...
document.write("<div class='Estilo13'><font color='#ffffff'><center><strong>Usted ha visitado nuestra Página <b><br>" + amt() + "</b> veces.<br> Gracias...!</strong></center></font></div>")
              ...
              <table width="486" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#336699">
                <tr>
                  <td><img src="../img/pilatos.jpg" alt="PILATOS" width="125" height="100" border="0" usemap="#Map5"></td>
                  <td><img src="../img/aquiles.jpg" alt="AQUILES" width="125" height="100" border="0" usemap="#Map6"></td>
                  <td><img src="../img/sigaf.jpg" alt="SIGAF" width="125" height="106" border="0" usemap="#Map7"></td>
                  ...
                  <td><img src="../img/digital_doc.jpg" alt="DIGITALDOC" width="125" height="106" border="0" usemap="#Map11"></td>
                </tr>
              </table>
              <map name="Map5">
                <area shape="rect" coords="0,2,124,96" href="http://fcpndigital.umsa.bo" target="http://fcpndigital.umsa.bo">
              </map>
              <map name="Map6">
                <area shape="rect" coords="4,3,122,94" href="http://fcpndigital.umsa.bo:8080/cp2010" target="http://fcpndigital.umsa.bo:8080/cp">
              </map>
              <map name="Map7">
                <area shape="rect" coords="5,1,123,100" href="http://fcpn.umsa.bo/sigaf" target="http://fcpn.umsa.bo/sigaf">
              </map>
              <map name="Map8">
                <area shape="rect" coords="4,4,124,105" href="http://fcpnvirtual.umsa.bo" target="http://fcpnvirtual.umsa.bo">
              </map>
              <map name="Map9">
                <area shape="rect" coords="118,52,120,54" href="http://fcpnvirtual.umsa.bo/dfis" target="http://fcpnvirtual.umsa.bo/dfis">
              <area shape="rect" coords="2,2,122,107" href="#"></map>
              <map name="Map10">
                <area shape="rect" coords="7,6,124,114" href="http://fcpnvirtual.umsa.bo/olimpiada" target="http://fcpnvirtual.umsa.bo/olimpiada">
              </map>
              <map name="Map11">
                <area shape="rect" coords="-1,3,152,145" href="http://fcpndigital.umsa.bo/digitaldoc" target="http://fcpndigital.umsa.bo/digitaldoc">
              </map>
              </marquee>
              </div>              </td>
              <td width="4">&nbsp;</td>
              <td width="150" bgcolor="#8fb1d2"><table width="150" height="111" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#8fb1d2" bgcolor="#336699">
                <tr>
                  <td>                  <div align="center"><img src="../img/novedades.GIF" width="105" height="112" border="0" usemap="#Map12"></div></td>
                </tr>
...
<map name="Map">
  <area shape="rect" coords="-1,1,84,31" href="http://www.google.com" target="http://www.google.com" alt="B&uacute;squeda en Google">
</map>
<map name="Map2">
  <area shape="rect" coords="0,-1,94,26" href="#http://www.la-razon.com" target="http://www.la-razon.com" alt="Peri&oacute;dico La Raz&oacute;n">
</map>
...
<map name="Map12"><area shape="rect" coords="1,3,105,111" href="#"></map></body>
</html>
