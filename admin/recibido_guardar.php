...
$link=conexion();
$consulta ="SELECT * FROM recibida order by id_rec DESC limit 1";
...
$numResultados = mysql_num_rows($resultado);
	if($numResultados>0)
	{
		...
		$pa_fecha_hora=$linea["fecha_hora"];
		...
		$pa_tipo=$linea["tipo"];    
		$fojas=$linea["fojas"];
		$id_remitente=$linea["id_remitente"]; 
  ...
  <tr>
    <td height="248" colspan="2"><table width="780" border="0" cellpadding="0" cellspacing="0">
          <tr>
			...
			<table style="position:absolute; top:172px;left:3px;" width="132" height="246" border="0" align="center" cellpadding="0" cellspacing="0">			
              <tr>
                <td height="92"><center><script src="menu_admin.js"></script></center></td>
              </tr>
              <tr>
                <td>             </td>
              </tr>
              ...
              <table width="498" height="246" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="494" bgcolor="#336699"><div align="center">
				   <iframe src="recibido_show.php" id="marco" style="width:490;height:477">
                                                 ...
                                                 <tr>
                                                   <td bgcolor="#B1CBE4"><table width="396" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#EDF7FF">
                                                     <tr>
													   ...
													   <div align="right">Fecha de Ingreso:</div>													   </td>
                                                       <td width="260" height="15" bgcolor="#E1F1FF" class="Estilo65">
													   &nbsp;
													   <?php  echo $pa_fecha_hora;?>												       </td>
                                                     </tr>
                                                     <tr>
