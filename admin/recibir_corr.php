...
{		
	...
	{	
		...
		if($imprimir == 1)
		{
			...
			$sqlr = "SELECT rut FROM reportes WHERE rut like '%,$rut,%' and responsable like '$nombre1'";
...
onClick="abrir4('reporte/reporte_rut_rec.php?rut='+'<? echo $unidad;?>'+','+'<? echo $rut;?>'+','+'<? echo $tipo;?>'+','+'<? echo $fecha;?>'+','+'<? echo $nombre1;?>'+','+'<? echo $fojas;?>'+','+'<? echo $estado;?>'+','+'<? echo $valor1;?>');">
<?
				echo '</center></td>';
			}
			elseif ($alert == 1)
...
<?
			...
			<table width="50" border="0">
					<tr>
						<td align="char" class="Estilo78" width="50">'; echo $correlativo;echo "</td>
					</tr>
			</table>";	
			echo '</center></td>
   	        <td height="50" bgcolor="#E1F1FF" class="Estilo78"><center>';
...
<? echo '     
			...
			<td height="50" bgcolor="#E1F1FF" class="Estilo78"><center>';
			$cargo = ' Mensajero';
			echo '<a href="despacho_mens.php?id='.$id_c.'&cargo='.$cargo.'">Despachar</a>';
			echo'</center></td>
       	</tr>';
		}
	}//end while
