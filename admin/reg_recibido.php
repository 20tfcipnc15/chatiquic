...
if($num>0)
{
	...
	$sql = "SELECT reg_interno FROM recibida order by reg_interno DESC"; 
	$resp=mysql_query($sql);
	$linea=mysql_fetch_array($resp);
	$reg_int=$linea["reg_interno"]; 
?>
<html>
<head>
                  ...
                  <td width="494" bgcolor="#336699"><div align="center">
                    <table width="490" height="246" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#8fb1d2">
                        <tr>
                                           ...
                                           <span class="Estilo77">&nbsp;&nbsp;Reg. Interno Actual N&ordm; <? echo $reg_int;?></span>
										   <center>
                                             <form name="registro_recibida" method="post" action="recibido_save.php">
                                               ...
                                               <table width="400" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                                                 ...
                                                 <tr>
                                                   <td bgcolor="#B1CBE4"><table width="396" border="0" align="center" cellpadding="0" cellspacing="2">
													   ...
													   $fecha=fecha_hora(); 
													   ?>
  &nbsp;<span class="Estilo64">&nbsp;&nbsp;<? echo $fecha;?></span></td>
                                                       </tr>                                         
													    <tr>
                                                         <td height="15"><div align="right"><span class="Estilo78">Recibido por:</span></div></td>
                                                         <td bgcolor="#CCDDEE" class="Estilo65">&nbsp;&nbsp;
														 <span class="Estilo65"><? echo $nom;?>
                                                           <input name="recibido_por" type="hidden" style="width:248px" class="Estilo64" value ="<? echo $nom;//echo $_SESSION['id_user'];?>"/>
                                                         </span></td>
                                                       </tr>
													    <tr>
													      ...
													      <td height="15" bgcolor="#CCDDEE" class="Estilo59">&nbsp;
                                                              <select name="tipo" style="width:248px" class="Estilo64">
                                                                ...
                                                                <option selected>Notas Recibidas</option>
...
<?
$result=mysql_query("select * from remitente order by nombre ASC",$link);
//Llenamos el combo
...
?>
                                                       ...
                                                       <tr>
                                                         ...
                                                         <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                                           <input name="reg_externo" type="text" style="width:248px" class="Estilo64" onKeyPress="return numeros_letras_especiales(event)"/>
                                                         </span></td>
                                                       </tr>
                                                       <tr>
													   ...
													   <tr>
                                                         ...
                                                         <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo7">&nbsp;
													   ...
													   <tr bgcolor="#CCDDEE">
													     ...
													     <td background="img/fondo_cuadrado.jpg"><span class="Estilo64">&nbsp;
                                                           <input name="fojas" type="text" class="Estilo64" id="fojas" style="width:248px" onKeyPress="return solo_numeros(event)" />
                                                         </span></td>
												     </tr>
													   <tr>
													     ...
													     <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;<span class="Estilo59">
                                                           <select name="asignacion" style="width:248px" class="Estilo64">
                                                             <option selected>Sra. Silvia Urquidi</option>
                                                             <option>Sra. Patricia Alvarez Roa</option>
                                                             <option>Lic. Enrique Figueroa</option>
                                                             <option>M. Sc. Franz Cuevas Quiroz</option>
															 <option></option>
                                                           </select>
                                                         </span></span></td>
												     </tr>
													   <tr>
                                                         <td height="15" bgcolor="#CCDDEE"><div align="right" class="Estilo78">Despacho Inmediato: </div></td>
													     <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
													       <input type="checkbox" name="despacho" value="checkbox" id="checkbox">
                                                       ...
                                                       <tr>
                                                         <td height="17" colspan="2" bgcolor="#CCDDEE" class="Estilo59"><div align="center">
                                                             <input name="enviar" type="submit" class="Estilo59" style="width:90px;background-color:#4791C5;border:0px;margin:1px;padding:0px; font-weight: bold;" value="Enviar Datos" >&nbsp;&nbsp;&nbsp;&nbsp;
                                               ...
                                               <input type="hidden" name="reg" id="case" value="<? echo $reg;?>">
                                             </form> 
                          </center></td>
                        </tr>
                      </table>
