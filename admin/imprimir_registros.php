...
//		$destino=$linea["destino"];
		...
		$sqlr = "SELECT rut FROM reportes WHERE rut like '%,$rut,%' and responsable like '$nombre' and fecha_sol like '%$fecha_sol%'";
...
{ 
	...
	{  	
		...
		$sqlr = "SELECT rut FROM reportes WHERE rut like '%,$rut,%' and responsable like '$nombre' and id_uni = '$id_unidad' and fecha_sol like '%$fecha_sol%'";
		$resr = mysql_query($sqlr) or die ("Error de b&uacute;squeda en la BD: ". mysql_Error());
		$numr = mysql_num_rows($resr);
		if($numr <= 0 and $tipo != 'Titulo Academico' and $tipo != 'Conclusion de Estudios' and $tipo != 'Titulo en Provision Nacional'  and $tipo != 'Defensa de Tesis' )
		{		
			echo '
        	<tr> ';
			echo '<td height="50" width="51" bgcolor="#E1F1FF" class="Estilo78"><center>'; 
...
?>
                    ...
                    <a href="javascript:seleccionar_todo()">Marcar todos</a> | <a href="javascript:deseleccionar_todo()">Marcar ninguno</a></td>
                        ...
                        <table width="470" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td width="29" height="21" background="../img/encabezado_tabla_01.gif">&nbsp;</td>
                            <td width="412" background="../img/encabezado_tabla_02.gif"><div align="center" class="Estilo59">DEFENSAS DE TESIS</div></td>
                            <td width="29" background="../img/encabezado_tabla_04.gif">&nbsp;</td>
                          </tr>
                          <tr>
                            <td height="2" colspan="3"></td>
                        ...
                        <table width="470" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                          ...
                          <tr>
                            <td bgcolor="#B1CBE4"><table width="466" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#EDF7FF">
                                <tr>
                                  <td width="51" height="15" bgcolor="#4791C5" class="Estilo2"><div align="center">
                                      <button class="Estilo59" style="width:48px;background-color:#4791C5;border:0px;margin:1px;padding:0px; font-weight: bold;" onClick="valoresdt(this.form, 'dt[]')">Imprimir</button>
                                  </div></td>
                                  <td width="54" height="15" bgcolor="#4791C5" class="Estilo2"><div align="center">R.U.T.</div></td>
                                  <td width="86" height="15" bgcolor="#4791C5" class="Estilo2"><div align="center">Fecha Ingreso </div></td>
                                  <td width="70" bgcolor="#4791C5"><div align="center" class="Estilo2">Correlativo</div></td>
...
{ 
	...
	{  	
		...
		$numr = mysql_num_rows($resr);
//		if($numr <= 0)
		if($numr <= 0 and ($tipo == 'Titulo Academico' or $tipo == 'Conclusion de Estudios' or $tipo == 'Titulo en Provision Nacional'  or $tipo == 'Defensa de Tesis' ))
		{		
			echo '
        	<tr> ';
			echo '<td height="50" width="51" bgcolor="#E1F1FF" class="Estilo78"><center>'; 
			echo '<input type="checkbox" name="dt[]" value="'.$rut.'">';
			echo '<input type="hidden" name="dt[]" value="'.$rut.'">';
			echo '</center></td>';
            echo '<td height="50" width="54" bgcolor="#E1F1FF" class="Estilo78"><center>'; 
			echo $rut;
			echo '</center></td>
...
?>
                                  ...
                                  <tr>
                                    <td height="15" colspan="12" class="Estilo78"><button class="Estilo59" style="width:48px;background-color:#4791C5;border:0px;margin:1px;padding:0px; font-weight: bold;" onClick="valoresdt(this.form, 'dt[]')">Imprimir</button>
                                        <a href="javascript:seleccionar_todo()">Marcar todos</a> | <a href="javascript:deseleccionar_todo()">Marcar ninguno</a></td>
                                  </tr>
                                </form>
                            </table></td>
