...
$consulta ="SELECT * FROM correspondencia where destino like '%$unidad%'";
                    ...
                    <table width="490" height="246" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#8fb1d2">
                        <tr>
                                           <td background="../img/fondo_cuerpo.gif"><center>
                                             <p align="left" class="Estilo77">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $unidad .' - '. $nombre;?><br>
                                             ...
                                             <table width="346" border="0" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                                               ...
                                               <tr>
                                                 <td bgcolor="#B1CBE4"><table width="476" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#EDF7FF">
                                                     <tr>
                                                       <td width="48" height="15" bgcolor="#4791C5" class="Estilo2"><div align="center">R.U.T.</div></td>
                                                       ...
                                                       <td width="105" bgcolor="#4791C5"><div align="center" class="Estilo2">Tipo de Tr&aacute;mite </div></td>
                                                       <td width="84" bgcolor="#4791C5"><div align="center" class="Estilo2">Referencias</div></td>
													   <td width="84" bgcolor="#4791C5"><div align="center" class="Estilo2">Detalle</div></td>
                                                     </tr>
<?
            {
$i=0;
