...
//recuperar el id_C que se envio de despacho_save_x.php con la variable id_c
$id_c = $_GET['id_c'];
...
$rut = $vec['rut'];
//efff
$documentoadj=$vec['documento'];
$docdoc=substr("$documentoadj",17,-5);

/////////////////////////////////////efffffff
//cuenta cuantas veces hay "-" si hay solo 1 no  pasa nada porq es un solo destino, pero si son 2 "-" ej: "1-tic_2014-a" eso quiere decir que hay mas de un destino por lo tanto hace un substring...miejjjj ya le estoy guachando chevere ejejjeje
$cont = substr_count($rut,"-");
if($cont == 2)
{
//efff---------saca por ejemplo de:"1-tic_2014-A" solo mostrara menos 2:"1-tic_2014"
