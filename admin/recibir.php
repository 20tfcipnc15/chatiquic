...
if($numResultados>0)
{
	...
	$i++;
?></p>
                                             <form name="form1" method="post" action="recibir_save.php">
                                             <table width="400" height="21" border="0" cellpadding="0" cellspacing="0">
                                                 <tr>
                                                   <td width="29" height="21" background="../img/encabezado_tabla_01.gif">&nbsp;</td>
                                                   <td width="342" background="../img/encabezado_tabla_02.gif"><div align="center" class="Estilo59">DATOS GENERALES DEL TRAMITE </div></td>
                                               ...
                                               <table width="400" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                                                 ...
                                                 <tr>
                                                   <td bgcolor="#B1CBE4"><table width="396" border="0" align="center" cellpadding="0" cellspacing="2">
                                                       ...
                                                       <tr>
                                                         <td height="15"><div align="right"><span class="Estilo78">Registro Interno:</span></div></td>
                                                         <td bgcolor="#CCDDEE" class="Estilo65">&nbsp;&nbsp;&nbsp;<? echo $reg_int;?></td>
                                                       </tr>
                                                       <tr>
                                                       ...
                                                       <tr>
                                                         ...
                                                         <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo65">&nbsp;&nbsp;&nbsp;<? echo $correlativo;?> <span class="Estilo77">
                                                       ...
                                                       <tr>
                                                         ...
                                                         <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo65">&nbsp;&nbsp;&nbsp;<? echo $hoja_ruta;?><span class="Estilo77">
                                                       ...
                                                       <tr>
                                                         ...
                                                         <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><table width="250" height="60" border="0" align="right" cellpadding="0" cellspacing="0">
                                                             <tr>
                                                       ...
                                                       <tr bgcolor="#CCDDEE">
                                                         ...
                                                         <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo65">&nbsp;&nbsp;&nbsp;<? echo $fojas;?><span class="Estilo77">
                                                           <input type="hidden" name="fojas" value="<? echo $fojas;?>">
                                                         </span></span></td>
                                                       </tr>
                                                       <tr>
                                                         <td height="15"><div align="right" class="Estilo78">Enviado por:</div></td>
                                                         <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo65"> &nbsp;&nbsp;&nbsp;<? echo $responsable; ?></span></td>
                                                       </tr>
                                                       <tr>
                                                         <td height="15" bgcolor="#CCDDEE"><div align="right" class="Estilo78">Recibido  por:</div></td>
                                                         <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo65"> &nbsp;&nbsp;&nbsp;<? echo $nombre; ?></span></td>
                                                       </tr>
                                                       <tr>
                                                         <td height="4" colspan="2" class="Estilo59"></td>
                                                       </tr>
                                                   </table></td>
                                                 </tr>
                                                 <tr>
                                              ...
                                              <BR>
                                               <table width="400" height="21" border="0" cellpadding="0" cellspacing="0">
                                                 <tr>
                                                   <td width="29" height="21" background="../img/encabezado_tabla_01.gif">&nbsp;</td>
                                                   <td width="342" background="../img/encabezado_tabla_02.gif"><div align="center" class="Estilo59">CONFIRMAR LA RECEPCION  </div></td>
                                                   <td width="29" background="../img/encabezado_tabla_04.gif">&nbsp;</td>
                                                 </tr>
                                                 <tr>
                                                   <td height="2" colspan="3"></td>
                                               ...
                                               <table width="400" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                                                 ...
                                                 <tr>
                                                   <td bgcolor="#B1CBE4"><table width="396" border="0" align="center" cellpadding="0" cellspacing="2">
                                                       ...
                                                       <tr>
                                                         <td width="390" bgcolor="#CCDDEE" class="Estilo78"></td>
                                                       </tr>
                                                       
                                                       <tr>
                                                         <td height="10" class="Estilo59"><table width="390" border="0" cellpadding="0" cellspacing="2">
                                                             <tr>
                                                               <td height="15" class="Estilo37"><div align="right">Recibido:</div></td>
                                                               <td width="257" background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo65"> &nbsp;&nbsp;
                                                                     <input name="recibido" type="checkbox" id="recibido" value="ok" checked>
                                                               </span></td>
                                                             </tr>
                                                             <tr>
                                                               <td height="15" class="Estilo37"><div align="right"><span class="Estilo77">Estado del tr&aacute;mite: </span></div></td>
                                                             ...
                                                             <tr>
                                                               <td height="15" class="Estilo37">&nbsp;</td>
                                                               <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE">&nbsp;</td>
                                                             </tr>
                                                             <tr>
                                                               <td height="15" colspan="2" class="Estilo37"><div align="center">
  <span class="Estilo77">
  <input type="hidden" name="id_c" value="<? echo $id_c;?>">
  </span>
