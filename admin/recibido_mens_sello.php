  ...
  &nbsp;&nbsp;Usuario: <? echo $nombre; ?></p>
                      ...
                      <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="642" background="../img/encabezado_tabla_02.gif"><div align="center" class="Estilo59">DATOS GENERALES DE LOS TR&Aacute;MITES </div></td>
			...
			if ($vector[0] != 0)
				...
				elseif ($vector[1] != 0)
					...
					elseif ($vector[2] >= 30)
						...
						elseif ($vector[2] >= 15)
							$alert = 2;
							/*elseif ($vector[2] >= 5 and $nombre != $destino and $estado != 'PENDIENTE' and $num7 <= 0)
								$alert = 4;*/
								else
									$alert = 0;	
									
/*			if ($vector[2] < 5 and $vector[2] > 2 and $nombre != $destino and $estado != 'PENDIENTE' and $num7 <= 0)
				$alert = 5;*/
/////////////////////////////////////////////////////////////////////////////		
//		if($imprimir == 1 and $alert != 4)
		if($imprimir == 1)
		{
			...
			$sqlr = "SELECT rut FROM reportes WHERE fecha_sol like '%2012%' and rut like '%,$rut,%' and responsable like '$nombre'";
			...
			$dd++;
?>
<input name="unidad" type="button" class="Estilo78" style="height:17px;width:50px;background-color:#FF8000;border:0px;margin:1px;padding:0px; cursor:pointer;" value="<? echo $rut;?>" onClick="abrir4('config.php?rut='+'<? echo $id_c;?>');">

<input name="unidad" type="button" class="Estilo78" style="height:17px;width:50px;background-color:#FF8000;border:0px;margin:1px;padding:0px; cursor:pointer;" value="" onClick="abrir4('reporte/reporte_rut_rec.php?rut='+'<? echo $unidad;?>'+','+'<? echo $rut;?>'+','+'<? echo $tipo;?>'+','+'<? echo $fecha;?>'+','+'<? echo $nombre;?>'+','+'<? echo $fojas;?>'+','+'<? echo $estado1;?>'+','+'<? echo $id_c;?>'+','+'<? echo $id_unidad;?>');">
<?
			echo '</center></td>';
            }			
			elseif ($alert == 0)
			{
				...
				$aa++;
?>				
<input name="unidad" type="button" class="Estilo78" style="height:17px;width:50px;background-color:#E1F1FF;border:0px;margin:1px;padding:0px; cursor:pointer;" value="<? echo $rut;?>" onClick="abrir4('config.php?rut='+'<? echo $id_c;?>');">

<input name="unidad" type="button" class="Estilo78" style="height:17px;width:50px;background-color:#E1F1FF;border:0px;margin:1px;padding:0px; cursor:pointer;" value="" onClick="abrir4('reporte/reporte_rut_rec.php?rut='+'<? echo $unidad;?>'+','+'<? echo $rut;?>'+','+'<? echo $tipo;?>'+','+'<? echo $fecha;?>'+','+'<? echo $nombre;?>'+','+'<? echo $fojas;?>'+','+'<? echo $estado1;?>'+','+'<? echo $id_c;?>'+','+'<? echo $id_unidad;?>');">
<?
				echo '</center></td>';
			}
			elseif ($alert == 1)
			{
				...
				$bb++;
?>	
<input name="unidad" type="button" class="Estilo83" style="height:17px;width:50px;background-color:#b81d0c;border:0px;margin:1px;padding:0px; cursor:pointer;" value="<? echo $rut;?>" onClick="abrir4('config.php?rut='+'<? echo $id_c;?>');">

<input name="unidad" type="button" class="Estilo78" style="height:17px;width:50px;background-color:#b81d0c;border:0px;margin:1px;padding:0px; cursor:pointer;" value="" onClick="abrir4('reporte/reporte_rut_rec.php?rut='+'<? echo $unidad;?>'+','+'<? echo $rut;?>'+','+'<? echo $tipo;?>'+','+'<? echo $fecha;?>'+','+'<? echo $nombre;?>'+','+'<? echo $fojas;?>'+','+'<? echo $estado1;?>'+','+'<? echo $id_c;?>'+','+'<? echo $id_unidad;?>');">
<?
				echo '</center></td>';
			}
			elseif ($alert == 2)
			{
				...
				$cc++;
?>			
<input name="unidad" type="button" class="Estilo78" style="height:17px;width:50px;background-color:#FFFF6A;border:0px;margin:1px;padding:0px; cursor:pointer;" value="<? echo $rut;?>" onClick="abrir4('config.php?rut='+'<? echo $id_c;?>');">

<input name="unidad" type="button" class="Estilo78" style="height:17px;width:50px;background-color:#FFFF6A;border:0px;margin:1px;padding:0px; cursor:pointer;" value="" onClick="abrir4('reporte/reporte_rut_rec.php?rut='+'<? echo $unidad;?>'+','+'<? echo $rut;?>'+','+'<? echo $tipo;?>'+','+'<? echo $fecha;?>'+','+'<? echo $nombre;?>'+','+'<? echo $fojas;?>'+','+'<? echo $estado1;?>'+','+'<? echo $id_c;?>'+','+'<? echo $id_unidad;?>');">
<?
			...
			elseif ($alert == 5)
			{
				...
				$gg++;
?>		
<input name="unidad" type="button" class="Estilo78" style="height:17px;width:50px;background-color:#BCFFB9;border:0px;margin:1px;padding:0px; cursor:pointer; f" value="<? echo $rut;?>" onClick="abrir4('config.php?rut='+'<? echo $id_c;?>');">

<input name="unidad" type="button" class="Estilo78" style="height:17px;width:50px;background-color:#BCFFB9;border:0px;margin:1px;padding:0px; cursor:pointer;" value="" onClick="abrir4('reporte/reporte_rut_rec.php?rut='+'<? echo $unidad;?>'+','+'<? echo $rut;?>'+','+'<? echo $tipo;?>'+','+'<? echo $fecha;?>'+','+'<? echo $nombre;?>'+','+'<? echo $fojas;?>'+','+'<? echo $estado1;?>'+','+'<? echo $id_c;?>'+','+'<? echo $id_unidad;?>');">
<?
				echo '</center></td>';
			}
	        echo '<td height="50" bgcolor="#E1F1FF" class="Estilo78"><center>'; 
