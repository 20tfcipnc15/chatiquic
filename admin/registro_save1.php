		...
		//if para saber si valor5 es vacio no tiene boleta
				if($valor5=="")
					...
					else
					{
						...
						$referencias = $tipito.' Responsable: '.$valor1.' por la actividad de: '.$valor2.', solicitado por la Unidad '.$valor3.' por un monto de '.$valor4.' Bs. con n�mero de Boleta: '.$valor5.'.';
					}
}
		...
		//if para saber si valor5 es vacio no tiene boleta
				if($valor4=="")
					...
					else
					{
						...
						$referencias = $tipito.' Responsable: '.$valor1.' por la actividad de: '.$valor2.', solicitado por la Unidad '.$valor3.' con n�mero de Boleta: '.$valor4.'.';
					}
}
if($id_tram=="Otros Descargos Cierre de Cargos")
{
		...
		//if para saber si valor es vacio no tiene boleta
					...
					else
					{
						...
						$referencias = $tipito.' Nombre del Descargo: '.$valor0.' Responsable: '.$valor1.' por la actividad de: '.$valor2.', solicitado por la Unidad '.$valor3.' con n�mero de Boleta: '.$valor4.'.';
					}
}
		...
		{				
						...
						if($valor2=="reposicion")
						{
							...
							else
							{
								...
								$referencias = $tipito.' '.$subtramite1.' para Reposicion, Responsable del Fondo: '.$valor3.', solicitado por la Unidad '.$valor4.' por un monto de '.$valor5.' Bs. con n�mero de Boleta '.$valor6.'.';
							}
						}
						else
						{
							...
							else
							{
								...
								$referencias = $tipito.' '.$subtramite1.' para cierre, Responsable del Fondo: '.$valor3.', solicitado por la Unidad '.$valor4.' por un monto de '.$valor5.' Bs. con n�mero de Boleta '.$valor6.'.';
							}
						}
		}
		...
		if($subtramite1 == "Otros Descargos Rotatorios")
		{
						...
						if($valor2=="reposicion")
						{
							...
							else
							{
								...
								$referencias = $tipito.' '.$subtramite1.','.$valor1.' para Reposicion, Responsable del Fondo: '.$valor3.', solicitado por la Unidad '.$valor4.' por un monto de '.$valor5.' Bs. con n�mero de Boleta '.$valor6.'.';
							}
						}
						else
						{
							...
							else
							{
								...
								$referencias = $tipito.' '.$subtramite1.','.$valor1.' para cierre, Responsable del Fondo: '.$valor3.', solicitado por la Unidad '.$valor4.' por un monto de '.$valor5.' Bs. con n�mero de Boleta '.$valor6.'.';
							}
						}
		}
...
//efffffffffffff         ahora para el pclzip
		...
		/* Llamamos el metodo que creara el nuevo fichero a�adiendo los ficheros especificados y separados por comas */
...
//Insertamos la primera asignaci�n en la tabla correspondencia
