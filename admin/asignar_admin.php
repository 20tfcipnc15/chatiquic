...
function verifica()
{  
    if((document.asignar.admin.value.length<2))
	{   //si el largo de nombre es menor a 2 caracteres 
        document.asignar.admin.focus(); //el puntero del mouse queda en nombre
		finalizarIns();
	...
	{   //si el largo de nombre es menor a 2 caracteres 
		...
		finalizarIns();
		var mensaje='Debe seleccionar la Instruciion del Tramite';
		div=document.getElementById('mensaje');
		div.innerHTML=div.innerHTML + mensaje;
        return 0; //devolvemos un cero para dejar de validar 
    } 
            ...
            <td bgcolor="#B1CBE4"><table width="396" border="0" cellpadding="0" cellspacing="2">
                ...
                <tr>
                  ...
                  <td bgcolor="#CCDDEE"><p><span class="Estilo7"> 
                           &nbsp;<textarea style="width:242px; height:60px " name="comentario" class="Estilo64"></textarea>
                  </span> </p></td>
                </tr>
                <tr>
...
?></td>
                ...
                <tr>
                  <td height="15" class="Estilo78"><div align="right"><span class="Estilo37">Instrucci&oacute;n:</span></div></td>
                  <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE">
&nbsp;<span class="Estilo65"><? $result=mysql_query("select instruccion,valor from instruccion order by valor ASC",$link);
//Llenamos el combo
if ($row = mysql_fetch_array($result))
{ 
...
?>
             ...
             <td>
                 <table border="0" cellpadding="0" cellspacing="0" width="130">
                   <tr>
                   <td height="21" bgcolor="#CCDDEE" class="Estilo37"><div align="right">Archivar:</div></td>
                   </tr>
                 </table>
             </td>
             <td>
                  ...
                  <tr>
                    ...
                    <td width="38" bgcolor="#CCDDEE"><input type="checkbox" name="pendiente" value="checkbox" id="pendiente"></td>
                  </tr>
                 </table>
             </td>
             </tr>
...
$cargo=$linea["cargo"]; 
if($cargo == 'Mensajero' or $nombre == 'Yomar Michel' or $nombre == 'Isabel Paez')
{
?>
                <tr>
...
?>                  </td>
                ...
                <tr>
                  ...
                  <td bgcolor="#CCDDEE">
&nbsp;<input style="width:242px" type="text" name="otro" class="Estilo64" /></td>
                </tr>
                <tr>
                  <td class="Estilo37"><div align="right">Correlativo:</div></td>
                  <td bgcolor="#CCDDEE">
&nbsp;<input style="width:242px" type="text" name="correlativo" class="Estilo64" /></td>
                </tr>

<!--                <tr>
                  <td bgcolor="#CCDDEE" class="Estilo37"><div align="right">Correlativo:</div></td>
                  <td bgcolor="#CCDDEE">&nbsp;
                      <input style="width:248px" type="text" name="correlativo" class="Estilo64" /></td>
                </tr>
                <tr>
                  <td class="Estilo37"><div align="right">N&ordm; Fojas:</div></td>
                  <td bgcolor="#CCDDEE">&nbsp;
                      <input style="width:248px" type="text" name="fojas" class="Estilo64" /></td>
                </tr>
                <tr>
                  <td bgcolor="#ccddee" class="Estilo37"><div align="right">Hoja de ruta:</div></td>
                  <td bgcolor="#CCDDEE">&nbsp;
                      <input style="width:248px" type="text" name="hoja_ruta" class="Estilo64" /></td>
                </tr>-->
<? }?>
                <tr>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td colspan="2"><div align="center">
                      ...
                      &nbsp;&nbsp;&nbsp;&nbsp;
                    <input name="cancelar222" type="reset" class="Estilo59" style="width:90px;background-color:#4791C5;border:0px;margin:1px;padding:0px; font-weight: bold;" value="Cancelar" />
                  </div></td>
                </tr>
            </table></td>
          </tr>
...
<div id="finalizarInscripcion" style="display:none">
  <div class="formPanel">
	<div>
        ...
        <table align="center">
            <td>
<input name="enviar22" type="button" class="Estilo59" style="width:90px;background-color:#4791C5;border:0px;margin:1px;padding:0px; font-weight: bold;" value="Cerrar" onClick="cancelIns()">
            </td>
        </table>
       </div>
    </div>
