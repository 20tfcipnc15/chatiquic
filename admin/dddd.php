...
{	
	...
	(NULL,'$rut','$unidad','$fecha','$correlativo','$hoja_ruta','$tipo','$referencias','$fojas','$nombre','$destino','$comentario','$ip','$estado')";
...
//header("Location: despacho_mostrar_x.php?long=$long&fecha=$fecha&tipo=$tipo&destino=$destino&correlativo=$correlativo&hoja=$hoja_ruta&referencias=$referencias&fojas=$fojas&nombre=$nombre&rut=$rut&estado=$estado");
