...
{
	$id=$vector[$i];
	$sql = "SELECT * FROM correspondencia WHERE rut like '$id' and (fecha like '%2010%' or fecha like '%2009%' or fecha like '%2011%' or fecha like '%2012%' or fecha like '%2013%'or fecha like '%2014%'or fecha like '%2015%') order by id_c DESC";
