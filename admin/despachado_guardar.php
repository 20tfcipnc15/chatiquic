...
$consulta ="SELECT * FROM despachada order by id_despachada DESC limit 1";
...
if($numResultados>0)
{
	...
	{
		$pa_despachada=$linea["id_despachada"]; 
		$pa_fecha_hora=$linea["fecha_hora"];
		$pa_correlativo=$linea["correlativo"];
		$pa_hoja_ruta=$linea["hoja_ruta"];
		$pa_dirigido=$linea["dirigido"];
