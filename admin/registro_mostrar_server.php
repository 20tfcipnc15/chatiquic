...
if($numResultados>0)
{
	while($linea=mysql_fetch_array($resultado))
	{
		...
		$estado=$linea["estado"];
		//effff
		$documentoadjext=$linea['documento'];
		$dudu=substr("$documentoadjext",17,-5);
		//efffff
?>
<html>
<head>
                                               ...
                                               <table width="400" border="0" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                                                 ...
                                                 <tr>
                                                   <td bgcolor="#B1CBE4"><table width="396" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#EDF7FF">
                                                     ...
                                                     <tr>
                                                       <td height="15" bordercolor="#74ABD3" class="Estilo78"><div align="right">Instruccion:</div></td>
                                                       <td height="15" bgcolor="#E1F1FF" class="Estilo65">&nbsp;
                                                           <?php  echo $estado;?></td>
                                                     </tr>
													 <tr>
													 ...
													 <tr>
                                                       <td height="15" colspan="2" bgcolor="#CCDDEE" class="Estilo78"><table width="300" border="0" align="center" cellpadding="0" cellspacing="0">
														 ...
														 <tr>
                                                           ...
                                                           <td>
														  <form name="form4" method="post" action="reporte/reporte_rut_2.php">
                                                            ...
                                                            <input name="unidad" type="hidden" value="<? echo $cunidad;?>" />
                                                            <input name="fecha" type="hidden" value="<? echo $fecha;?>" />
                                                            <input name="tipo" type="hidden" value="<? echo $tipo;?>" />
															<input name="estado" type="hidden" value="<? echo $estado;?>" />
                                                          </form>                                                           </td>
                                                         </tr>
                                                       </table></td>
												     </tr>
