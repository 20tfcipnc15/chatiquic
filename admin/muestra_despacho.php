              ...
              <table width="498" height="246" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="494" bgcolor="#336699"><div align="center">
                    <table width="488" height="246" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#8fb1d2">
                      <tr>
...
&nbsp;&nbsp;Usuario: <? echo $nombre; ?> </span></p>
                            <p class="Estilo77">                              Los datos de la correspondencia<br>
                              <br>
                          ...
                          <table width="400" border="0" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                              ...
                              <tr>
                                <td bgcolor="#B1CBE4"><table width="396" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#EDF7FF">
                                  <tr>
                                    <td height="15" colspan="2" bordercolor="#74ABD3" class="Estilo78"><div align="center">
                                      <span class="Estilo77">R.U.T. 
                                      <?php  echo $rut?>
									  </span>
                                    </div></td>
                                    </tr>
                                    <tr>
                                      <td width="130" height="15" bordercolor="#74ABD3" class="Estilo78"><div align="right">Fecha de Despacho: </div></td>
                                    ...
                                    <tr>
                                      ...
                                      <td height="15" bgcolor="#E1F1FF" class="Estilo64">&nbsp;&nbsp;&nbsp;<?php echo $correlativo; ?></td>
                                    </tr>
...
?>
                                    ...
                                    <tr>
                                      <td height="15" bgcolor="#CCDDEE" class="Estilo78"><div align="right">Comentario:</div></td>
                                      <td height="15" bgcolor="#E1F1FF" class="Estilo65">&nbsp;
                                          <?php  echo $comentario;?>
                                      </td>
                                    </tr>
