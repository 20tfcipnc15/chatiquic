    ...
    <td height="248" colspan="2"><table width="133" border="0" cellpadding="0" cellspacing="0">
      <tr>
		...
		<table width="1000" height="246" border="0" cellpadding="0" cellspacing="0" align="center">
            <tr height="117">
              <td width="134"><table style="position:absolute; top:171px; left:3px; width: 126px; height: 137px;"width="132" height="240" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="134" height="92"><script src="menu_sp.js"></script></td>
                </tr>
              </table></td>
              <td bgcolor="#EDF7FF"><? //include('online.php')?>
                <table width="872" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="9">&nbsp;</td>
                    <td width="715"><table width="708" height="246" border="2" align="left" cellpadding="0" cellspacing="0" bordercolor="#8fb1d2">
                      <tr>
                        <td width="803" background="../img/fondo_cuerpo.gif"><br>
                            <p><span class="Estilo77">&nbsp;&nbsp;&nbsp;&nbsp;Unidad: <?php echo $unidad1;?><br>
