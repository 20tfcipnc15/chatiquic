                    ...
                    <table width="493" height="246" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#8fb1d2">
                      <tr>
                        <td background="../img/fondo_cuerpo.gif"><center>
                          ...
                          <form name="registro_recibida" method="post" action="adi_uni_save.php">
                              <div align="left">
                                  <? echo $msm;?>
                                  ...
                                  <table width="400" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                                    ...
                                    <tr>
                                      <td bgcolor="#B1CBE4"><table width="396" border="0" align="center" cellpadding="0" cellspacing="2">
                                          ...
                                          <tr>
                                            <td width="130" height="15" bgcolor="#CCDDEE"><div align="right" class="Estilo78">C&oacute;digo de Unidad: </div></td>
                                            <td width="260" height="15" bgcolor="#CCDDEE" class="Estilo59">&nbsp;<span class="Estilo64">
                                              <input name="codigo" type="text" style="width:248px" class="Estilo64" onKeyPress="return solo_numeros(event)"/>
                                            </span></td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                            ...
                                            <td bgcolor="#CCDDEE" class="Estilo64">&nbsp;
                                                <input name="sigla" type="text" style="width:248px" class="Estilo64" onKeyPress="return numeros_letras_especiales(event)"/></td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                            ...
                                            <td background="../admin/img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                                  <input name="e_mail" value=""type="text" style="width:248px" class="Estilo64"/>
                                            </span></td>
                                          </tr>
                                          <tr>
