...
if ($numResultados > 0)
{
	...
	{		
		...
		$sql = "SELECT * FROM correspondencia WHERE rut like '$rut' and referencias like '$referencias1' order by id_c ASC";
...
(id_c,rut,unidad,fecha,correlativo,hoja_ruta,tipo,referencias,fojas,responsable,destino,comentario,ip,estado,sw) VALUES (NULL,'$rut','$unidad','$fecha','$correlativo','$hoja_ruta','$tipo','$referencias','$fojas','$responsable','$destino','$comentario','$ip','$estado','$sw')";
	$res = mysql_query($sql);
