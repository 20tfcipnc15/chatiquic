                      ...
                      <tr>
                        <td background="../img/fondo_cuerpo.gif"><center>
                          ...
                          <form name="registro_recibida" method="post" action="seleccion.php">
                              <div align="left">
                                <p align="center" class="Estilo77">Confirmaci&oacute;n de la elimicaci&oacute;n realizada </p>
                                <center>
                                  <table width="400" height="21" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td width="29" height="21" background="../img/encabezado_tabla_01.gif">&nbsp;</td>
                                      <td width="342" background="../img/encabezado_tabla_02.gif"><div align="center" class="Estilo59">REGISTRO ELIMINADO </div></td>
                                  ...
                                  <table width="400" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                                    <tr>
                                      <td bgcolor="#CCDDEE" class="Estilo77"><div align="center">
                                          <p>&nbsp;</p>
                                        <p class="Estilo74">El registro ha sido eliminado satisfactoriamente...! </p>
                                        <p>&nbsp;</p>
                                      </div></td>
                                    </tr>
                                    <tr>
                                      <td bgcolor="#B1CBE4"><table width="396" border="0" align="center" cellpadding="0" cellspacing="2">
                                          <tr>
                                            <td width="390" height="17" class="Estilo59"><div align="center">
                                                <input name="enviar22" type="submit" class="Estilo59" style="width:90px;background-color:#4791C5;border:0px;margin:1px;padding:0px; font-weight: bold;" value="Aceptar" >
                                              &nbsp;&nbsp;&nbsp;&nbsp;</div></td>
                                          </tr>
                                        </table>
                                         </td>
