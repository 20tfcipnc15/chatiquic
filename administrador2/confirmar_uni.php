                    ...
                    <table width="493" height="246" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#8fb1d2">
                      <tr>
                        <td background="../img/fondo_cuerpo.gif"><center>
                          ...
                          <form name="registro_recibida" method="post" action="seleccion.php">
                              <div align="left">
                                <p align="center" class="Estilo77">Introduzca uno o varios Par&aacute;metros                                </p>
                                <center>
                                  ...
                                  <table width="400" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                                    ...
                                    <tr>
                                      <td bgcolor="#B1CBE4"><table width="396" border="0" align="center" cellpadding="0" cellspacing="2">
                                          ...
                                          <tr>
                                            <td width="130" height="15"><div align="right"><span class="Estilo78">Id unidad </span></div></td>
                                            <td width="260" background="../admin/img/fondo_cuadrado.jpg" bgcolor="#CCDDEE" class="Estilo78">&nbsp;&nbsp;<? echo $id_unidad; ?></span></td>
                                          </tr>
                                          <tr>
                                            <td height="15" bgcolor="#CCDDEE"><div align="right" class="Estilo78">C&oacute;digo de Unidad: </div></td>
                                            <td height="15" bgcolor="#CCDDEE"><span class="Estilo78">&nbsp;&nbsp;<? echo $codigo; ?></span></td>
                                          </tr>
                                          <tr>
                                            <td height="15"><div align="right"><span class="Estilo78">Nombre:</span></div></td>
                                            <td background="../admin/img/fondo_cuadrado.jpg" bgcolor="#CCDDEE" class="Estilo78">&nbsp;&nbsp;<? echo $nombre; ?></span></td>
                                          </tr>
                                          <tr>
                                            <td height="15" bgcolor="#CCDDEE"><div align="right"><span class="Estilo78">Sigla:</span></div></td>
                                            <td bgcolor="#CCDDEE" class="Estilo78">&nbsp;&nbsp;<? echo $sigla; ?></span></td>
                                          </tr>
                                          <tr>
                                            <td height="15"><div align="right"><span class="Estilo78">Responsable:</span></div></td>
                                            <td background="../admin/img/fondo_cuadrado.jpg" bgcolor="#CCDDEE" class="Estilo78">&nbsp;&nbsp;<? echo $responsable; ?></span></td>
                                          </tr>
                                          <tr>
                                            <td height="15" bgcolor="#CCDDEE" class="Estilo78"><div align="right" class="Estilo78">Direcci&oacute;n:</div></td>
                                            <td background="../admin/img/fondo_cuadrado.jpg" bgcolor="#CCDDEE" class="Estilo78"></span>&nbsp;&nbsp;<? echo $direccion; ?></td>
                                          </tr>
                                          <tr>
                                            <td height="15" class="Estilo78"><div align="right" class="Estilo78">E-mail:</div></td>
                                            <td background="../admin/img/fondo_cuadrado.jpg" bgcolor="#CCDDEE" class="Estilo78">&nbsp;&nbsp;<? echo $e_mail; ?></span></td>
                                          </tr>
                                          <tr>
                                            <td height="15" bgcolor="#CCDDEE" class="Estilo78"><div align="right" class="Estilo78">Tel&eacute;fono:</div></td>
                                            <td background="../admin/img/fondo_cuadrado.jpg" bgcolor="#CCDDEE" class="Estilo78">&nbsp;&nbsp;<? echo $telefono; ?></span></td>
                                          </tr>
                                          <tr>
                                            <td colspan="2" class="Estilo78"><div align="center"></div>                                              </td>
                                          </tr>
