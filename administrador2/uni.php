...
<table style="position:absolute;" width="1000" border="0" align="center" cellspacing="0">
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;Usuario: <? echo $nombre; ?></span></p>
                    <p align="center" class="Estilo77">Sus datos han sido correctamente adicionados.</p>
                    <div align="left">
                      ...
                      <table width="694" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                        ...
                        <tr>
                          <td bgcolor="#B1CBE4"><table width="690" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#EDF7FF">
                              <tr>
                                <td width="43" bgcolor="#4791C5"><div align="center" class="Estilo2">id_unidad</div></td>
                                <td width="79" height="15" bgcolor="#4791C5" class="Estilo2"><div align="center">codigo</div></td>
                                <td width="86" bgcolor="#4791C5"><div align="center" class="Estilo2">nombre</div></td>
                                <td width="61" bgcolor="#4791C5" class="Estilo2"><div align="center">sigla</div></td>
                                <td width="61" bgcolor="#4791C5"><div align="center" class="Estilo2">responsable</div></td>
                                <td width="140" bgcolor="#4791C5"><div align="center" class="Estilo2">e_mail</div></td>
                                <td width="40" bgcolor="#4791C5" class="Estilo2"><div align="center">telefono</div></td>
                                <td width="90" bgcolor="#4791C5"><div align="center" class="Estilo2">direccion:</div></td>
                              </tr>
<?php  	
		//OBTENEMOS TODOS LOS CAMPOS DEL REGISTRO PARA DESPLEGARLOS POR PANATALLA
		$consulta = "INSERT INTO unidad (id_unidad,cod_uni,nombre,sigla,responsable,direccion,e_mail,telefono)
		VALUES ('' ,'$codigo', '$nombre1', '$sigla', '$responsable', '$direccion', '$e_mail', '$telefono')";
		$resultado = mysql_query($consulta) or die ("Error de búsqueda en la BD: ". mysql_Error());
		
    	//OBTENEMOS EL REGISTRO RECIEN INSERTADO	
