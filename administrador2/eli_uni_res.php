                      ...
                      <table width="694" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                        ...
                        <tr>
                          <td bgcolor="#B1CBE4"><table width="690" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#EDF7FF">
                              <tr>
                                <td width="50" bgcolor="#4791C5" class="Estilo2"><div align="center">ID</div></td>
                                <td width="127" bgcolor="#4791C5" class="Estilo2"><div align="center">Nombre</div></td>
                                <td width="121" height="15" bgcolor="#4791C5" class="Estilo2"><div align="center">Responsable</div></td>
                                <td width="151" bgcolor="#4791C5"><div align="center" class="Estilo2">Codigo</div></td>
                                <td width="110" bgcolor="#4791C5"><div align="center" class="Estilo2">Telefono</div></td>
                                <td width="117" bgcolor="#4791C5" class="Estilo2"><div align="center">E-mail</div></td>
                                <td width="117" bgcolor="#4791C5" class="Estilo2"><div align="center">Eliminar</div></td>
                              </tr>
<?php
$total = 0;
if($cadena  != null)
...
if ($num > 0)
{
	while($fila = mysql_fetch_array($res))
	{
	    ...
	    echo '</center></td>
            ...
            echo $nombre;
            echo '</center></td>';
            echo '<td height="50" width="84" bgcolor="#E1F1FF" class="Estilo78"><center>';
            echo $responsable;
	    echo'</center></td>
	    ...
	    echo '</center></td>
            <td height="50" width="82" bgcolor="#E1F1FF" class="Estilo78"><center>';
	    echo '<a href="eliminar_uni.php?id='.$id_unidad.'">Eliminar</a>';
	    echo '</center></td>
            </tr>';
        }
}
