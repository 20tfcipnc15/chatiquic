...
$sql = "SELECT *
		FROM unidad
		WHERE sigla != 'null' and sigla != '0' and sigla != ''";
...
{		
	...
	{	
		...
		$sql2 = "INSERT INTO rut (id_rut,rut,id_unidad) VALUES (null,'$rut','$id_uni')";
                                      ...
                                      <td bgcolor="#B1CBE4"><table width="396" border="0" align="center" cellpadding="0" cellspacing="2">
                                          ...
                                          <tr>
                                            <td bgcolor="#CCDDEE">
                                              ...
                                              <br>
                                                <div align="center" class="Estilo65">Los registros RUT han sido iniciados en 0 correctamente...!</div>
                                                <br>
                                              </div></td>
                                            </tr>
