...
<table width="1000" border="0" cellspacing="0">
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;Usuario: <? echo $nombre; ?></span></p>
                    ...
                    <div align="left">
                      <form name="mod_user" method="post" action="save_mod_rut.php">
...
<?php
$total = 0;
$sql = "select * from rut where id_rut = '$id_rut'";
...
?>
                                            ...
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                                  <input name="nombre" type="text" style="width:200px" class="Estilo64" onKeyPress="return numeros_letras_especiales(event)" value ="<? echo $rut;?>"/>
                                            </span></td>
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">
                                                  <input name="rut" type="text" style="width:200px" class="Estilo64" onKeyPress="return numeros_letras_especiales(event)" />
                                            </span></td>
                                          </tr>
                                          <tr>
                                            <td height="15"><div align="right"><span class="Estilo78">ID UNIDAD:</span></div></td>
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                                  <input name="id_unidad" type="text" style="width:200px" class="Estilo64" onKeyPress="return numeros_letras_especiales(event)" value ="<? echo $id_unidad;?>"/>
                                            </span></td>
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">
                              ...
                              <tr>
                                <td height="10" colspan="10" bgcolor="#CCDDEE" class="Estilo78"> <input name="id_rut" type="hidden" value ="<? echo $id_rut;?>"/></td>
                              </tr>
                                          <tr>
