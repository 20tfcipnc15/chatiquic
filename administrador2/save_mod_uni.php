...
if($nombre!=null)
{
   	$consulta ="UPDATE unidad SET nombre = '$nombre' WHERE id_unidad = '$id_unidad'";
	$resultado=mysql_query($consulta) or die ("Error de b�squeda en la BD: ". mysql_Error());
}
if($sigla!=null)
{
	$consulta ="UPDATE unidad SET sigla = '$sigla' WHERE id_unidad = '$id_unidad'";
	$resultado=mysql_query($consulta) or die ("Error de b�squeda en la BD: ". mysql_Error());
}
if($responsable!=null)
{
	$consulta ="UPDATE unidad SET responsable = '$responsable' WHERE id_unidad = '$id_unidad'";
	$resultado=mysql_query($consulta) or die ("Error de b�squeda en la BD: ". mysql_Error());
}
if($cod_uni!=null)
{
	$consulta ="UPDATE unidad SET cod_uni = '$cod_uni' WHERE id_unidad = '$id_unidad'";
	$resultado=mysql_query($consulta) or die ("Error de b�squeda en la BD: ". mysql_Error());
}
if($direccion!=null)
{
	$consulta ="UPDATE unidad SET direccion = '$direccion' WHERE id_unidad = '$id_unidad'";
	$resultado=mysql_query($consulta) or die ("Error de b�squeda en la BD: ". mysql_Error());
}
if($telefono!=null)
{
	$consulta ="UPDATE unidad SET telefono = '$telefono' WHERE id_unidad = '$id_unidad'";
	$resultado=mysql_query($consulta) or die ("Error de b�squeda en la BD: ". mysql_Error());
}
if($e_mail!=null)
{
	$consulta ="UPDATE unidad SET e_mail = '$e_mail' WHERE id_unidad = '$id_unidad'";
	$resultado=mysql_query($consulta) or die ("Error de b�squeda en la BD: ". mysql_Error());
}
                      ...
                      <table width="450" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                        ...
                        <tr>
                          <td bgcolor="#B1CBE4"><table width="450" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#EDF7FF">
                                  ...
                                  <tr>
                                            <td height="25" width="120" bgcolor="#CCDDEE"><div align="right"><span class="Estilo78">Unidad:</span></div></td>
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;<? echo $nombre;?></span></td>
                                          </tr>
                                  <tr>
                                            <td height="25" width="120" bgcolor="#CCDDEE"><div align="right"><span class="Estilo78">Sigla:</span></div></td>
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                                  <? echo $sigla;?>
                                            </span></td>
                                          </tr>
                                          <tr>
                                            <td height="25"><div align="right"><span class="Estilo78">Responsable:</span></div></td>
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                                <? echo $responsable;?>
                                            </span></td>
                                          </tr>
                                          <tr>
                                            <td height="25" bgcolor="#CCDDEE"><div align="right"><span class="Estilo78">Codigo:</span></div></td>
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                                 <? echo $cod_uni;?>
                                            </span>                                            </td>
                                          </tr>
                                          <tr>
                                            <td height="25" class="Estilo78"><div align="right" class="Estilo78">Direccion:</div></td>
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                                 <? echo $direccion;?>
                                            </span></td>
                                          </tr>
                                          <tr>
                                            <td height="25" bgcolor="#CCDDEE" class="Estilo78"><div align="right" class="Estilo78">Telefono:</div></td>
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                                  <? echo $telefono;?>
                                            </span></td>
                                          </tr>
                                          <tr>
                                            <td height="25" class="Estilo78"><div align="right" class="Estilo78">E-mail:</div></td>
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                                 <? echo $e_mail;?>
                                            </span></td>
                                          </tr>
                             <tr>
                                <td height="10" colspan="10" bgcolor="#CCDDEE" class="Estilo78"></td>
                              </tr>
                              <tr>
