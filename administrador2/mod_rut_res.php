...
$consulta = "SELECT id_rut FROM rut WHERE rut like '%$rut%' or id_rut = '$id_rut' or id_unidad = '$id_uni'";
                    ...
                    <p align="center" class="Estilo77">Se han encontrado <?php echo $numResultados;?> coincidencias.</p>
                      <table width="504" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="446" background="../img/encabezado_tabla_02.gif"><div align="center" class="Estilo59">DATOS GENERALES DEL RUT</div></td>
                      ...
                      <table width="504" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                        <tr>
                          <td></td>
                        </tr>
                        <tr>
                          <td bgcolor="#B1CBE4"><table width="500" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#EDF7FF">
                              <tr>
                                <td width="145" bgcolor="#4791C5" class="Estilo2"><div align="center">ID RUT</div></td>
                                <td width="213" bgcolor="#4791C5"><div align="center" class="Estilo2">RUT</div></td>
                                <td width="134" bgcolor="#4791C5" class="Estilo2"><div align="center">ID UNIDAD</div></td>
                                <td width="86" bgcolor="#4791C5"><div align="center" class="Estilo2">Modificar</div></td>
                              </tr>
<?php
$total = 0;
$sql = "select * from rut where id_rut = '$id_rut' ORDER BY id_rut ASC";
...
if ($num > 0)
{
	while($fila = mysql_fetch_array($res))
	{
	    ...
	    echo '</center></td>
        <td height="50" bgcolor="#E1F1FF" class="Estilo78"><center>';
	    echo '<a href="modificar_rut.php?id='.$id_rut.'">Modificar</a>';
	    echo '</center></td>
		</tr>';
	}
}
