                      ...
                      <table width="694" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                        ...
                        <tr>
                          <td bgcolor="#B1CBE4"><table width="690" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#EDF7FF">
                              <tr>
                                <td width="61" bgcolor="#4791C5" class="Estilo2"><div align="center">Nombre</div></td>
                                <td width="79" height="15" bgcolor="#4791C5" class="Estilo2"><div align="center">Usuario</div></td>
                                <td width="86" bgcolor="#4791C5"><div align="center" class="Estilo2">Contrasenia</div></td>
                                <td width="61" bgcolor="#4791C5"><div align="center" class="Estilo2">Cargo</div></td>
                                <td width="70" bgcolor="#4791C5" class="Estilo2"><div align="center">Tipo</div></td>
                                <td width="61" bgcolor="#4791C5"><div align="center" class="Estilo2">Id Unidad</div></td>
...
if ($num > 0)
{
	while($fila = mysql_fetch_array($res))
	{
	    ...
	    echo '</center></td>
            <td height="50" width="82" bgcolor="#E1F1FF" class="Estilo78"><center>';
	    echo '<a href="eliminar_user.php?id='.$id_user.'">Eliminar</a>';
	    echo '</center></td>
            </tr>';
        }
}
...
//	header ('Location: eli_user.php?cad='.$msm);
}
}
