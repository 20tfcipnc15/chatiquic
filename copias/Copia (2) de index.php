			...
			<table width="132" height="250" border="0" cellpadding="0" cellspacing="0" align="center">
             <tr height="117">
                <td><table width="132" height="200" border="0" align="center" cellpadding="0" cellspacing="0">
				  ...
				  <tr>
                    <td><div align="center"><script src="javascript/menu_usu.js"></script></div></td>
                  </tr>
                  <tr>
                    <td><form name="form1" method="post" action="verif_usu.php">
                        <table width="127" height="80" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                          <tr>
