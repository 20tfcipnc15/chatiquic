    ...
    <td height="248" colspan="2"><table width="780" border="0" cellpadding="0" cellspacing="0">
          <tr>
			...
			<table style="position:absolute;top:170px;left:3px;" width="132" height="246" border="0" cellpadding="0" cellspacing="0" align="center">
              ...
              <tr height="117">
                <td><table style="position:absolute; top:3px; left:0px; height: 170px;" width="132" height="465" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><script src="javascript/menu_usu.js"></script>&nbsp;</td>
                  </tr>
                  <tr>
            ...
            <td width="150" rowspan="3" bgcolor="#8fb1d2">
              <table width="146" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td><div style="position:absolute;top:193px;left:634px;" class="Contenido_principal">
