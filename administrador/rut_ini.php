                    ...
                    <table width="493" height="246" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#8fb1d2">
                      <tr>
                        <td background="../img/fondo_cuerpo.gif"><center>
                          ...
                          <form name="registro_recibida" method="post" action="rut_ini_ok.php">
                              <div align="left">
                                <center>
                                  ...
                                  <table width="400" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                                    ...
                                    <tr>
                                      <td bgcolor="#B1CBE4"><table width="396" border="0" align="center" cellpadding="0" cellspacing="2">
                                          ...
                                          <tr>
                                            <td bgcolor="#CCDDEE">
                                              <div align="right" class="Estilo78">
                                              <br>
                                                <div align="center" class="Estilo65">Los registros RUT van a se iniciados en 0.<br>
                                                Esta Ud. seguro?</div>
                                                <br>
                                              </div></td>
                                            </tr>
                                          ...
                                          <tr>
                                            <td height="10" class="Estilo59"><div align="center">
  <input name="enviar2" type="submit" class="Estilo59" style="width:90px;background-color:#4791C5;border:0px;margin:1px;padding:0px; font-weight: bold;" value="SI" >
                                            </div></td>
                                          </tr>
                                          <tr>
                                            <td height="2" bgcolor="#CCDDEE" class="Estilo59"></td>
                                          </tr>
                                        </table>
                                         </td>
                                    </tr>
