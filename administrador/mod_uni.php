                    ...
                    <table width="493" height="246" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#8fb1d2">
                      <tr>
                        <td background="../img/fondo_cuerpo.gif"><center>
                          ...
                          <form name="registro_recibida" method="post" action="mod_uni_res.php">
                              <div align="left">
                                ...
                                <center>
                                  <table width="400" height="21" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                      ...
                                      <td width="342" background="../img/encabezado_tabla_02.gif"><div align="center" class="Estilo59">MODIFICAR UNIDAD</div></td>
                                  ...
                                  <table width="400" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                                    ...
                                    <tr>
                                      <td bgcolor="#B1CBE4"><table width="396" border="0" align="center" cellpadding="0" cellspacing="2">
                                          <tr>
                                            <td height="15" width="140" bgcolor="#CCDDEE"><div align="right"><span class="Estilo78">Nombre:</span></div></td>
                                            <td width="252" background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE">
<span class="Estilo64">&nbsp;<?
$result=mysql_query("select nombre from unidad order by nombre ASC",$link);
if($row = mysql_fetch_array($result))
{
	echo '<select name = "nombre" style="width:248px" class="Estilo64">';
...
?>
                                          ...
                                          <tr>
                                            ...
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                                  <?
$result=mysql_query("select sigla from unidad order by nombre ASC",$link);
if($row = mysql_fetch_array($result))
{
	echo '<select name = "sigla" style="width:248px" class="Estilo64">';
	echo '<option selected></option>';
	do {
...
?>
                                          ...
                                          <tr>
                                            ...
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                                  <?
$result=mysql_query("select responsable from unidad order by nombre ASC",$link);
if($row = mysql_fetch_array($result))
{
	echo '<select name = "responsable" style="width:248px" class="Estilo64">';
	echo '<option selected></option>';
	do {
    	   echo '<option value= "'.$row["responsable"].'">'.$row["responsable"].'</option>';
	} while ($row = mysql_fetch_array($result));
	echo '</select>';
}
?>
                                          ...
                                          <tr>
                                            ...
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                                  <?
$result=mysql_query("select telefono from unidad order by nombre ASC",$link);
if($row = mysql_fetch_array($result))
{
	echo '<select name = "telefono" style="width:248px" class="Estilo64">';
	echo '<option selected></option>';
	do {
...
?>
                                          ...
                                          <tr>
                                            ...
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                                  <?
$result=mysql_query("select e_mail from unidad order by nombre ASC",$link);
if($row = mysql_fetch_array($result))
{
	echo '<select name = "e_mail" style="width:248px" class="Estilo64">';
	echo '<option selected></option>';
	do {
