                    ...
                    <table width="493" height="246" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#8fb1d2">
                      <tr>
                        <td background="../img/fondo_cuerpo.gif"><center>
                            ...
                            <p>
<?
	$consulta = "SELECT * FROM unidad WHERE id_unidad = $id_uni";
                            ...
                            <table width="400" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                              ...
                              <tr>
                                <td bgcolor="#B1CBE4"><table width="396" border="0" align="center" cellpadding="0" cellspacing="2">
                                    ...
                                    <tr>
                                      <td height="15" class="Estilo87"><div align="right"><span class="Estilo78">Sigla:</span></div></td>
                                      <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE" class="Estilo87"><span class="Estilo64">&nbsp;<? echo $sigla;?></span></td>
                                    </tr>
                                    <tr>
                                      <td height="15" class="Estilo87"><div align="right"><span class="Estilo78">Responsable:</span></div></td>
                                      <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE" class="Estilo87"><span class="Estilo64">&nbsp;<? echo $responsable;?></span></td>
                                    </tr>

                                    <tr>
                                      <td height="15" bgcolor="#CCDDEE" class="Estilo87"><div align="right" class="Estilo78">Direccion:</div></td>
                                      <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE" class="Estilo87"><span class="Estilo64">&nbsp;<? echo $direccion;?></span></td>
                                    </tr>
                                    <tr>
                                      <td height="15" class="Estilo87"><div align="right" class="Estilo78">Telefono:</div></td>
                                      <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE" class="Estilo87"><span class="Estilo64">&nbsp;<? echo $telefono;?></span></td>
                                    </tr>

                                    <tr>
                                      <td height="15" bgcolor="#CCDDEE" class="Estilo87"><div align="right"><span class="Estilo78">E-mail:</span></div></td>
                                      <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE" class="Estilo87"><span class="Estilo64">&nbsp;<? echo $e_mail;?></span></td>
                                    </tr>
                                    <tr>
