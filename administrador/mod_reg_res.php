                      ...
                      <table width="694" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                        ...
                        <tr>
                          <td bgcolor="#B1CBE4"><table width="690" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#EDF7FF">
                              <tr>
                                <td width="27" bgcolor="#4791C5" class="Estilo2"><div align="center">No</div></td>
                                <td width="65" bgcolor="#4791C5" class="Estilo2"><div align="center">RUT</div></td>
                                <td width="57" bgcolor="#4791C5"><div align="center" class="Estilo2">Fecha</div></td>
                                <td width="98" bgcolor="#4791C5" class="Estilo2"><div align="center">Unidad</div></td>
                                <td width="106" height="15" bgcolor="#4791C5" class="Estilo2"><div align="center">Correlativo</div></td>
                                <td width="108" bgcolor="#4791C5"><div align="center" class="Estilo2">Referencias</div></td>
                                <td width="113" bgcolor="#4791C5"><div align="center" class="Estilo2">Destino</div></td>
                                <td width="28" bgcolor="#4791C5"><div align="center" class="Estilo2">SW</div></td>
                                <td width="68" bgcolor="#4791C5"><div align="center" class="Estilo2">Modificar</div></td>
                              </tr>
<?php
$total = 0;
$sql = "select * from correspondencia where ".$cadena." ORDER BY id_c DESC";
