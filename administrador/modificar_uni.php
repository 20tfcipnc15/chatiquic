...
?>
                                          ...
                                          <tr>
                                            ...
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">
                                                  <input name="responsable" type="text" style="width:200px" class="Estilo64" onKeyPress="return numeros_letras_especiales(event)" />
                                            </span>                                            </td>
                                          </tr>
                                          <tr>
                                            ...
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">
                                                  <input name="cod_uni" style="width:200px" class="Estilo64" onKeyPress="return solo_numeros(event)" />
                                            </span>                                            </td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                            ...
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">
                                                  <input style="width:200px" class="Estilo64" name="telefono" onKeyPress="return solo_numeros(event)" />
                                            </span></td>
                                          </tr>
                                          <tr>
