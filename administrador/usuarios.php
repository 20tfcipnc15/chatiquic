...
<table style="position:absolute;" width="780" border="0" align="center" cellspacing="0">
                    ...
                    <table width="493" height="246" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#8fb1d2">
                      <tr>
                        <td background="../img/fondo_cuerpo.gif"><center>
                          ...
                          <form name="registro_recibida" method="post" action="sel_usuario.php">
                              <div align="left">
                                ...
                                <center>
                                  <table width="400" height="21" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                      ...
                                      <td width="342" background="../img/encabezado_tabla_02.gif"><div align="center" class="Estilo59">ADMINISTRACION DE CUENTAS DE USUARIO</div></td>
 ...
 <tr>
                                            <td height="15" colspan="2" bgcolor="#CCDDEE" class="Estilo87"><div align="center" class="Estilo79"><a href="adi_user1.php">Adicionar un nuevo Usuario</a></div></td>
                                            </tr>
                                          <tr>
                                            <td height="15" colspan="2" class="Estilo87"><div align="center" class="Estilo79"><a href="eli_user.php">Dar de baja a un Usuario</a></div></td>
                                            </tr>
                                          <tr>
                                            <td height="15" colspan="2" bgcolor="#CCDDEE" class="Estilo87"><div align="center" class="Estilo79"><a href="mod_user.php">Modificar la Cuenta de un Usuario</a></div></td>
                                            </tr>
                                          <tr>
