...
$sql ="SELECT referencias FROM correspondencia WHERE rut like '$rut' and id_c ='$ref' ORDER BY id_c ASC";
...
$consulta="SELECT * FROM correspondencia WHERE rut like '$rut' and referencias like '$referencias1' ORDER BY id_c ASC";
...
/*			$sql_rep = "DELETE reportes WHERE  rut like '%,$rut,%' and responsable like 	
		'$responsable' and fecha_sol like '%$anio%'";
		...
		{	$linea7 = mysql_fetch_array($res7);
			...
			$res_not = mysql_query($sql_not) or die ("Error de b&uacute;squeda en la BD: ". 	
			mysql_Error	());
			$not ++;
		}
	}		
