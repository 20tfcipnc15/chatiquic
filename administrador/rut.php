                      ...
                      <tr>
                        <td background="../img/fondo_cuerpo.gif"><center>
                          ...
                          <form name="registro_recibida" method="post" action="seleccion.php">
                              <div align="left">
                                <p align="center" class="Estilo77">Elija la tarea que desea realizar</p>
                                <center>
                                  <center>
                                    <table width="400" height="21" border="0" cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td width="29" height="21" background="../img/encabezado_tabla_01.gif">&nbsp;</td>
                                        <td width="342" background="../img/encabezado_tabla_02.gif"><div align="center" class="Estilo59">ADMINISTRACION DE R.U.T.</div></td>
                                    ...
                                    <table width="400" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                                      ...
                                      <tr>
                                        <td bgcolor="#B1CBE4"><table width="396" border="0" align="center" cellpadding="0" cellspacing="2">
                                            <tr>
                                              <td height="14" colspan="2" bgcolor="#CCDDEE" class="Estilo87"><div align="center" class="Estilo79 Estilo79"><a href="adi_rut.php" Estilo79">Adicionar nuevo RUT</a></div></td>
                                            </tr>
                                            <tr>
                                              <td height="15" colspan="2" class="Estilo87"><div align="center" class="Estilo79 Estilo79"><a href="mod_rut.php">Modificar RUT</a></div></td>
                                            </tr>
                                            <tr>
                                              <td height="15" colspan="2" bgcolor="#CCDDEE" class="Estilo87"><div align="center" class="Estilo79 Estilo79"><a href="eli_rut.php">Eliminar RUT</a><a href="eli_rut.php"></a></div></td>
                                            </tr>
                                            <tr>
                                              <td height="15" colspan="2" class="Estilo87"><div align="center" class="Estilo79 Estilo79"><a href="eli_user.php"><a href="rut_ini.php">Iniciar registros RUT</a></div></td>
                                            </tr>
                                            <tr>
