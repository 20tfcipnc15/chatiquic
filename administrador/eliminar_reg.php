...
if($sw==1)
{
	$sql = "delete from rut where rut = '$rut' order by id_rut DESC limit 1";
	$res = mysql_query($sql) or die ("Error de b&uacute;squeda en la BD: ". mysql_Error());	

}
$sql = "delete from correspondencia where id_c = '$id_c'";
$res = mysql_query($sql) or die ("Error de b&uacute;squeda en la BD: ". mysql_Error());
?>
                                            <tr>
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><div class="Estilo64" align="center">&nbsp;
                                                <br>
                                                <? echo 'El usuario especificado ha sido ELIMINADO correctamente...!';?>
                                                <br><br>
                                            </div></td>
                                          </tr>
                              <tr>
