...
function verifica()
{  
    if(document.reg_uni.nombre.value.length < 2)
	{   //si el largo de nombre es menor a 2 caracteres 
        document.reg_uni.nombre.focus(); //el puntero del mouse queda en nombre 
		finalizarIns();
    ...
    if(document.reg_uni.sigla.value.length < 2)
	{   //si el largo de nombre es menor a 2 caracteres 
        document.reg_uni.sigla.focus(); //el puntero del mouse queda en nombre 
		finalizarIns();
	...
	{ //sino enviamos el formulario 
        document.reg_uni.submit(); //enviamos formulario     
    } 
}
                    ...
                    <table width="493" height="246" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#8fb1d2">
                      <tr>
                        <td background="../img/fondo_cuerpo.gif"><center>
                          ...
                          <form name="reg_uni" method="post" action="adi_uni_save.php">
                              <div align="left">
                                  <? echo $msm;?>
                                  <p align="center" class="Estilo77">Introduzca la informaci&oacute;n necesaria para adicionar una Unidad<br>
                                  </p>
                                <center>
                                  <table width="400" height="21" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td width="29" height="21" background="../img/encabezado_tabla_01.gif">&nbsp;</td>
                                      <td width="342" background="../img/encabezado_tabla_02.gif"><div align="center" class="Estilo59">ADICIONAR UNIDADES</div></td>
                                  ...
                                  <table width="400" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                                    ...
                                    <tr>
                                      <td bgcolor="#B1CBE4"><table width="396" border="0" align="center" cellpadding="0" cellspacing="2">
                                          <tr>
                                            <td width="130" height="15"><div align="right"><span class="Estilo78">Nombre:</span></div></td>
                                            <td width="260" background="../admin/img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                                  <input name="nombre" value="" type="text" style="width:248px" class="Estilo64" onKeyPress="return numeros_letras_especiales(event)"/>
                                            </span></td>
                                          </tr>
                                          <tr>
                                            <td height="15" bgcolor="#CCDDEE"><div align="right"><span class="Estilo78">Sigla:</span></div></td>
                                            <td bgcolor="#CCDDEE" class="Estilo64">&nbsp;
                                                <input name="sigla" value="" type="text" style="width:248px" class="Estilo64" onKeyPress="return numeros_letras_especiales(event)"/></td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                            <td height="15" bgcolor="#CCDDEE" class="Estilo78"><div align="right" class="Estilo78">Direcci&oacute;n:</div></td>
                                            <td background="../admin/img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                                  <input name="direccion" value=""type="text" style="width:248px" class="Estilo64" onKeyPress="return numeros_letras_especiales(event)" />
                                            </span></td>
                                          </tr>
                                          <tr>
                                            <td height="15" class="Estilo78"><div align="right" class="Estilo78">E-mail:</div></td>
                                            <td background="../admin/img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                                  <input name="e_mail" value=""type="text" style="width:248px" class="Estilo64" onKeyPress="return numeros_letras_especiales(event)"/>
                                            </span></td>
                                          </tr>
                                          <tr>
                                            <td height="15" bgcolor="#CCDDEE" class="Estilo78"><div align="right" class="Estilo78">Tel&eacute;fono:</div></td>
                                            <td background="../admin/img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><p class="Estilo64">&nbsp;
                                                  <input name="telefono" value=""type="text" style="width:248px" class="Estilo64" onKeyPress="return solo_numeros(event)" />
                                            </p>                                              </td>
                                          </tr>
...
<input name="enviar22" type="submit" class="Estilo59" style="width:90px;background-color:#4791C5;border:0px;margin:1px;padding:0px; font-weight: bold; cursor:pointer" value="Enviar Datos">
