...
echo 'AAAAAAAAAA '.$cadena;

//$cadena = $cadena.' '.$atributo." = '".$id_unidad."' and ";
                    ...
                    <p align="center" class="Estilo77">Se han encontrado <?php echo $numResultados;?> coincidencias.</p>
                      <table width="617" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="559" background="../img/encabezado_tabla_02.gif"><div align="center" class="Estilo59">DATOS GENERALES DEL TR&Aacute;MITE </div></td>
                      ...
                      <table width="617" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                        <tr>
                          <td></td>
                        </tr>
                        <tr>
                          <td bgcolor="#B1CBE4"><table width="613" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#EDF7FF">
                              <tr>
                                <td width="30" bgcolor="#4791C5" class="Estilo2"><div align="center">No</div></td>
                                <td width="160" bgcolor="#4791C5" class="Estilo2"><div align="center">Nombre</div></td>
                                <td width="110" bgcolor="#4791C5" class="Estilo2"><div align="center">CI</div></td>
                                <td width="110" bgcolor="#4791C5"><div align="center" class="Estilo2">Cargo</div>                                  <div align="center"></div></td>
                                <td width="107" height="15" bgcolor="#4791C5" class="Estilo2"><div align="center">Usuario</div></td>
                                <td width="82" bgcolor="#4791C5"><div align="center" class="Estilo2">Modificar</div></td>
                              </tr>
<?php
$total = 0;
...
?>
                              <tr>
                                <td height="15" colspan="9" bgcolor="#CCDDEE" class="Estilo78">&nbsp;</td>
                              </tr>
                          </table></td>
                        </tr>
                        <tr>
