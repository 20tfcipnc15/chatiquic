                    ...
                    <table width="493" height="246" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#8fb1d2">
                      <tr>
                        <td background="../img/fondo_cuerpo.gif"><center>
                          ...
                          <form name="registro_recibida" method="post" action="mod_user_res.php">
                              <div align="left">
                                ...
                                <center>
                                  <table width="400" height="21" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                      ...
                                      <td width="342" background="../img/encabezado_tabla_02.gif"><div align="center" class="Estilo59">MODIFICAR CUENTA DE USUARIO</div></td>
                                  ...
                                  <table width="400" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                                    ...
                                    <tr>
                                      <td bgcolor="#B1CBE4"><table width="396" border="0" align="center" cellpadding="0" cellspacing="2">
                                          ...
                                          <tr>
                                            <td height="15" class="Estilo78"><div align="right" class="Estilo78">CI:</div></td>
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp; 
                                              <input name="ci" type="text" style="width:248px" class="Estilo64" onKeyPress="return solo_numeros(event)"/>
                                            </span></td>
                                          </tr>
                                          <tr>
                                            <td height="15" bgcolor="#CCDDEE" class="Estilo78"><div align="right" class="Estilo78">Palabra Clave:</div></td>
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                                  <input style="width:248px" class="Estilo64" name="clave" onKeyPress="return numeros_letras_especiales(event)"/>
                                            </span></td>
                                          </tr>
                                          <tr>
...
?>                                            </td>
                                          ...
                                          <tr>
                                            <td height="15" bgcolor="#CCDDEE" class="Estilo78"><div align="right" class="Estilo78">Rol de Usuario:</div></td>
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
<?
$result=mysql_query("select valor, desc_rol FROM rol order by id_rol ASC",$link);
if ($row = mysql_fetch_array($result))
{
	echo '<select name= "rol" style="width:248px" class="Estilo64">';
	echo '<option selected></option>';
	do {
		echo '<option value= "'.$row["valor"].'">'.$row["valor"].' - '.$row["desc_rol"].'</option>';
	} while ($row = mysql_fetch_array($result));
	echo '</select>';
}
?>
                                          ...
                                          <tr>
                                            <td height="17" colspan="2" bgcolor="#CCDDEE" class="Estilo59"><div align="center">
                                                <input name="enviar2" type="submit" class="Estilo59" style="cursor:pointer;width:90px;background-color:#4791C5;border:0px;margin:1px;padding:0px; font-weight: bold;" value="Buscar" >
                                              &nbsp;&nbsp;&nbsp;&nbsp;
