...
$sql = "INSERT INTO unidad (id_unidad,cod_uni,nombre,sigla,responsable,direccion,e_mail,telefono) VALUES (NULL,'','$nombre','$sigla','$responsable','$direccion','$e_mail','$telefono')";
