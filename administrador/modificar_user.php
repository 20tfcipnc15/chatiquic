                    ...
                    <div align="left">
                      ...
                      <table width="560" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="502" background="../img/encabezado_tabla_02.gif"><div align="center" class="Estilo59">MODIFICAR DATOS DEL USUARIO</div></td>
                      ...
                      <table width="560" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#74ABD3">
                        <tr>
                          <td></td>
                        </tr>
                        <tr>
                          <td bgcolor="#B1CBE4"><table width="556" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#EDF7FF">
<?php
$total = 0;
...
?>
                            <tr>
                                            ...
                                            <td width="208" background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
<? echo $nombre;?>
                                            </span></td>
                            <td width="220" background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">
                    <input name="nombre" type="text" style="width:215px" class="Estilo64" onKeyPress="return numeros_letras_especiales(event)" />
                                            </span></td>
                                    </tr>
                                          <tr>
...
<? echo $usuario;?>
                                            ...
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">
                                              <input name="usuario" type="text" style="width:215px" class="Estilo64" onKeyPress="return numeros_letras_especiales(event)" />
                                            </span></td>
                                    </tr>
                                          <tr>
...
<? echo $contrasenia;?>
                                            ...
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">
                                                  <input name="contrasenia" type="text" style="width:215px" class="Estilo64" onKeyPress="javascript:buscar(this)" />
                                            </span>                                            </td>
                                          </tr>
                                          <tr>
                 ...
                 <? echo $clave;?>
                                            ...
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">
                                                  <input name="clave" style="width:215px" class="Estilo64" onKeyPress="return numeros_letras_especiales(event)" />
                                            </span>                                            </td>
                                          </tr>
                                          <tr>
...
{
	echo '<select name= "unidad" style="width:215px" class="Estilo64">';
...
?>                                            </td>
                  ...
                  <? echo $cargo;?>
                                            ...
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">
                                                  <input style="width:215px" class="Estilo64" name="cargo" onKeyPress="return numeros_letras_especiales(event)" />
                                            </span></td>
                                          </tr>
                                          <tr>
...
<? echo $ci;?>
                                            ...
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">
                                                  <input name="ci" type="text" style="width:215px" class="Estilo64" onKeyPress="return solo_numeros(event)" />
                                            </span></td>
                                          </tr>
                                          <tr>
                                            <td height="15" class="Estilo78"><div align="right" class="Estilo78">Rol de Usuario:</div></td>
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
<? echo $tipo;?>
                                            </span></td>
                                            <td background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">
...
if ($row = mysql_fetch_array($result))
{
	echo '<select name= "rol" style="width:215px" class="Estilo64">';
	echo '<option selected></option>';
	do {
