                                      ...
                                      <td bgcolor="#B1CBE4"><table width="396" border="0" align="center" cellpadding="0" cellspacing="2">
                                          ...
                                          <tr>
                                            ...
                                            <td bgcolor="#CCDDEE" class="Estilo64">&nbsp;
                                                <select name="unidad_sol" style="width:248px" class="Estilo64">
                                          ...
                                          <tr>
                                            <td height="15" colspan="2" class="Estilo78"><span class="Estilo65">
                                              ...
                                              <table width="390" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#CCDDEE">
                                                <tr>
                                                  <td width="135"><div align="right" class="Estilo78">Tr&aacute;mites Conclu&iacute;dos:</div></td>
                                                  <td width="41" bgcolor="#b1cbe4"><div align="center">
                                                ...
                                                <tr>
                                                  ...
                                                  <td class="Estilo78">&nbsp;</td>
                                                  <td bgcolor="#b1cbe4">&nbsp;</td>
                                                </tr>
                                              </table>
                                              <span class="Estilo65">
...
<table style="position:absolute;top:167px;left:1px;"width="132" height="240" border="0" cellpadding="0" cellspacing="0">
  <tr>
