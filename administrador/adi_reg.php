                ...
                <div id="demoDer" class="Estilo64"> 
                  <select disabled="disabled" name="estados" id="estados" class="Estilo64" style="width:248px">
						<option value="0">Selecciona opci&oacute;n...</option>
                                          ...
                                          <tr>
                                            <td width="117" height="15"><div align="right"><span class="Estilo78">Fecha y Hora:</span></div></td>
                                            <td width="267" colspan="4" background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                          ...
                                          <tr>
                                            ...
                                            <td colspan="4" background="img/fon do_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                          ...
                                          <td colspan="4" background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                            <input name="hoja_ruta" type="text" style="width:248px" class="Estilo64" onKeyPress="return numeros_letras_especiales(event)"/>
                                          </span></td>
                                          </tr>
                                          <tr>
                                            <td height="19"><div align="right"><span class="Estilo78">Tipo:</span></div></td>
                                            <td colspan="4" background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;<span class="Estilo59">
                                                <?
...
if ($row = mysql_fetch_array($result))
{
	echo '<select name= "instruccion" style="width:248px" class="Estilo64">';
...
?>
                                          ...
                                          <tr>
                                            <td height="15" class="Estilo78"><div align="right" class="Estilo78">Activo:</div></td>
                                            <td colspan="4" background="img/fondo_cuadrado.jpg" bgcolor="#CCDDEE"><span class="Estilo64">&nbsp;
                                              <label>
                                              <?
$result=mysql_query("select valor, desc_es FROM estado order by id_e ASC",$link);
if ($row = mysql_fetch_array($result))
{
...
?>
                                          ...
                                          <tr>
                                            <td height="10" colspan="5" class="Estilo59"></td>
                                          </tr>
                                          <tr>
                                            <td height="17" colspan="5" bgcolor="#CCDDEE" class="Estilo59"><div align="center">
