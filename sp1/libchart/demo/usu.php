...
$pdf->SetFont('Times','B',12);
$pdf->Cell(0,4,'CORRESPONDENCIA Y TRAMITES PENDIETES: WILSON ANDRADE - DECANATO',0,1,'C');
...
{ 	
	...
	{  	*/
		...
		$consulta = "SELECT * FROM correspondencia WHERE destino like 'Wilson Andrade' or destino like 'Decanato' ORDER BY id_c DESC";
		...
		{		
			...
			{	
				$rut = $linea["rut"];
				$imprimir = 1;		
				/*$sql8 = "SELECT * FROM correspondencia WHERE destino like 'Silvia Urquidi' and sw=1 order by id_c DESC";
